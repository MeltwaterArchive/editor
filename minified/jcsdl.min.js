...
;("undefined"==typeof Crypto||!Crypto.util)&&function(){var m=window.Crypto={},p=m.util={rotl:function(h,g){return h<<g|h>>>32-g},rotr:function(h,g){return h<<32-g|h>>>g},endian:function(h){if(h.constructor==Number)return p.rotl(h,8)&16711935|p.rotl(h,24)&4278255360;for(var g=0;g<h.length;g++)h[g]=p.endian(h[g]);return h},randomBytes:function(h){for(var g=[];0<h;h--)g.push(Math.floor(256*Math.random()));return g},bytesToWords:function(h){for(var g=[],i=0,a=0;i<h.length;i++,a+=8)g[a>>>5]|=(h[i]&255)<<
24-a%32;return g},wordsToBytes:function(h){for(var g=[],i=0;i<32*h.length;i+=8)g.push(h[i>>>5]>>>24-i%32&255);return g},bytesToHex:function(h){for(var g=[],i=0;i<h.length;i++)g.push((h[i]>>>4).toString(16)),g.push((h[i]&15).toString(16));return g.join("")},hexToBytes:function(h){for(var g=[],i=0;i<h.length;i+=2)g.push(parseInt(h.substr(i,2),16));return g},bytesToBase64:function(h){if("function"==typeof btoa)return btoa(n.bytesToString(h));for(var g=[],i=0;i<h.length;i+=3)for(var a=h[i]<<16|h[i+1]<<
8|h[i+2],b=0;4>b;b++)8*i+6*b<=8*h.length?g.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(a>>>6*(3-b)&63)):g.push("=");return g.join("")},base64ToBytes:function(h){if("function"==typeof atob)return n.stringToBytes(atob(h));for(var h=h.replace(/[^A-Z0-9+\/]/ig,""),g=[],i=0,a=0;i<h.length;a=++i%4)0!=a&&g.push(("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(h.charAt(i-1))&Math.pow(2,-2*a+8)-1)<<2*a|"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(h.charAt(i))>>>
6-2*a);return g}},m=m.charenc={};m.UTF8={stringToBytes:function(h){return n.stringToBytes(unescape(encodeURIComponent(h)))},bytesToString:function(h){return decodeURIComponent(escape(n.bytesToString(h)))}};var n=m.Binary={stringToBytes:function(h){for(var g=[],i=0;i<h.length;i++)g.push(h.charCodeAt(i)&255);return g},bytesToString:function(h){for(var g=[],i=0;i<h.length;i++)g.push(String.fromCharCode(h[i]));return g.join("")}}}();
(function(){var m=Crypto,p=m.util,n=m.charenc,h=n.UTF8,g=n.Binary,i=m.MD5=function(a,b){var h=p.wordsToBytes(i._md5(a));return b&&b.asBytes?h:b&&b.asString?g.bytesToString(h):p.bytesToHex(h)};i._md5=function(a){a.constructor==String&&(a=h.stringToBytes(a));for(var b=p.bytesToWords(a),g=8*a.length,a=1732584193,d=-271733879,e=-1732584194,c=271733878,f=0;f<b.length;f++)b[f]=(b[f]<<8|b[f]>>>24)&16711935|(b[f]<<24|b[f]>>>8)&4278255360;b[g>>>5]|=128<<g%32;b[(g+64>>>9<<4)+14]=g;for(var g=i._ff,j=i._gg,k=
i._hh,l=i._ii,f=0;f<b.length;f+=16)var m=a,n=d,q=e,r=c,a=g(a,d,e,c,b[f+0],7,-680876936),c=g(c,a,d,e,b[f+1],12,-389564586),e=g(e,c,a,d,b[f+2],17,606105819),d=g(d,e,c,a,b[f+3],22,-1044525330),a=g(a,d,e,c,b[f+4],7,-176418897),c=g(c,a,d,e,b[f+5],12,1200080426),e=g(e,c,a,d,b[f+6],17,-1473231341),d=g(d,e,c,a,b[f+7],22,-45705983),a=g(a,d,e,c,b[f+8],7,1770035416),c=g(c,a,d,e,b[f+9],12,-1958414417),e=g(e,c,a,d,b[f+10],17,-42063),d=g(d,e,c,a,b[f+11],22,-1990404162),a=g(a,d,e,c,b[f+12],7,1804603682),c=g(c,a,
...
e=l(e,c,a,d,b[f+6],15,-1560198380),d=l(d,e,c,a,b[f+13],21,1309151649),a=l(a,d,e,c,b[f+4],6,-145523070),c=l(c,a,d,e,b[f+11],10,-1120210379),e=l(e,c,a,d,b[f+2],15,718787259),d=l(d,e,c,a,b[f+9],21,-343485551),a=a+m>>>0,d=d+n>>>0,e=e+q>>>0,c=c+r>>>0;return p.endian([a,d,e,c])};i._ff=function(a,b,g,d,e,c,f){a=a+(b&g|~b&d)+(e>>>0)+f;return(a<<c|a>>>32-c)+b};i._gg=function(a,b,g,d,e,c,f){a=a+(b&d|g&~d)+(e>>>0)+f;return(a<<c|a>>>32-c)+b};i._hh=function(a,b,g,d,e,c,f){a=a+(b^g^d)+(e>>>0)+f;return(a<<c|a>>>
32-c)+b};i._ii=function(a,b,g,d,e,c,f){a=a+(g^(b|~d))+(e>>>0)+f;return(a<<c|a>>>32-c)+b};i._blocksize=16;i._digestsize=16})();;
;JCSDL.Loader.addComponent(function(){var h=jQuery,w=function(a,b){var c,d,e,j=a.nodeName.toLowerCase();return"area"===j?(c=a.parentNode,d=c.name,!a.href||!d||"map"!==c.nodeName.toLowerCase()?!1:(e=h("img[usemap=#"+d+"]")[0],!!e&&v(e))):(/input|select|textarea|button|object/.test(j)?!a.disabled:"a"===j?a.href||b:b)&&v(a)},v=function(a){return h.expr.filters.visible(a)&&!h(a).parents().andSelf().filter(function(){return"hidden"===h.css(this,"visibility")}).length},A=0,B=/^ui-id-\d+$/;h.ui=h.ui||{};
...
!a.length?h(document):a},zIndex:function(a){if(void 0!==a)return this.css("zIndex",a);if(this.length)for(var a=h(this[0]),b;a.length&&a[0]!==document;){b=a.css("position");if("absolute"===b||"relative"===b||"fixed"===b)if(b=parseInt(a.css("zIndex"),10),!isNaN(b)&&0!==b)return b;a=a.parent()}return 0},uniqueId:function(){return this.each(function(){this.id||(this.id="ui-id-"+ ++A)})},removeUniqueId:function(){return this.each(function(){B.test(this.id)&&h(this).removeAttr("id")})}});h.extend(h.expr[":"],
{data:h.expr.createPseudo?h.expr.createPseudo(function(a){return function(b){return!!h.data(b,a)}}):function(a,b,c){return!!h.data(a,c[3])},focusable:function(a){return w(a,!isNaN(h.attr(a,"tabindex")))},tabbable:function(a){var b=h.attr(a,"tabindex"),c=isNaN(b);return(c||0<=b)&&w(a,!c)}});h(function(){var a=document.body,b=a.appendChild(b=document.createElement("div"));b.offsetHeight;h.extend(b.style,{minHeight:"100px",height:"auto",padding:0,borderWidth:0});h.support.minHeight=100===b.offsetHeight;
h.support.selectstart="onselectstart"in b;a.removeChild(b).style.display="none"});h("<a>").outerWidth(1).jquery||h.each(["Width","Height"],function(a,b){function c(a,b,c,e){return h.each(d,function(){b-=parseFloat(h.css(a,"padding"+this))||0;c&&(b-=parseFloat(h.css(a,"border"+this+"Width"))||0);e&&(b-=parseFloat(h.css(a,"margin"+this))||0)}),b}var d="Width"===b?["Left","Right"]:["Top","Bottom"],e=b.toLowerCase(),j={innerWidth:h.fn.innerWidth,innerHeight:h.fn.innerHeight,outerWidth:h.fn.outerWidth,
outerHeight:h.fn.outerHeight};h.fn["inner"+b]=function(a){return void 0===a?j["inner"+b].call(this):this.each(function(){h(this).css(e,c(this,a)+"px")})};h.fn["outer"+b]=function(a,d){return"number"!=typeof a?j["outer"+b].call(this,a):this.each(function(){h(this).css(e,c(this,a,!0,d)+"px")})}});if(h("<a>").data("a-b","a").removeData("a-b").data("a-b")){var x=h.fn.removeData;h.fn.removeData=function(a){return arguments.length?x.call(this,h.camelCase(a)):x.call(this)}}var y=/msie ([\w.]+)/.exec(navigator.userAgent.toLowerCase())||
[];h.ui.ie=y.length?!0:!1;h.ui.ie6=6===parseFloat(y[1],10);h.fn.extend({disableSelection:function(){return this.bind((h.support.selectstart?"selectstart":"mousedown")+".ui-disableSelection",function(a){a.preventDefault()})},enableSelection:function(){return this.unbind(".ui-disableSelection")}});h.extend(h.ui,{plugin:{add:function(a,b,c){var d,a=h.ui[a].prototype;for(d in c)a.plugins[d]=a.plugins[d]||[],a.plugins[d].push([b,c[d]])},call:function(a,b,c){var d=a.plugins[b];if(d&&a.element[0].parentNode&&
11!==a.element[0].parentNode.nodeType)for(b=0;b<d.length;b++)a.options[d[b][0]]&&d[b][1].apply(a.element,c)}},contains:h.contains,hasScroll:function(a,b){if("hidden"===h(a).css("overflow"))return!1;var c=b&&"left"===b?"scrollLeft":"scrollTop";return 0<a[c]?!0:(a[c]=1,a[c]=0,!1)},isOverAxis:function(a,b,c){return a>b&&a<b+c},isOver:function(a,b,c,d,e,j){return h.ui.isOverAxis(a,c,e)&&h.ui.isOverAxis(b,d,j)}})}var i=jQuery,C=0,z=Array.prototype.slice,D=i.cleanData;i.cleanData=function(a){for(var b=
0,c;null!=(c=a[b]);b++)try{i(c).triggerHandler("remove")}catch(d){}D(a)};i.widget=function(a,b,c){var d,e,j,f,g=a.split(".")[0],a=a.split(".")[1];d=g+"-"+a;c||(c=b,b=i.Widget);i.expr[":"][d.toLowerCase()]=function(a){return!!i.data(a,d)};i[g]=i[g]||{};e=i[g][a];j=i[g][a]=function(a,b){if(!this._createWidget)return new j(a,b);arguments.length&&this._createWidget(a,b)};i.extend(j,e,{version:c.version,_proto:i.extend({},c),_childConstructors:[]});f=new b;f.options=i.widget.extend({},f.options);i.each(c,
function(a,d){if(i.isFunction(d)){var e=function(){return b.prototype[a].apply(this,arguments)},j=function(c){return b.prototype[a].apply(this,c)};c[a]=function(){var a=this._super,b=this._superApply,c;return this._super=e,this._superApply=j,c=d.apply(this,arguments),this._super=a,this._superApply=b,c}}});j.prototype=i.widget.extend(f,{widgetEventPrefix:e?f.widgetEventPrefix:a},c,{constructor:j,namespace:g,widgetName:a,widgetBaseClass:d,widgetFullName:d});e?(i.each(e._childConstructors,function(a,
b){var c=b.prototype;i.widget(c.namespace+"."+c.widgetName,j,b._proto)}),delete e._childConstructors):b._childConstructors.push(j);i.widget.bridge(a,j)};i.widget.extend=function(a){for(var b=z.call(arguments,1),c=0,d=b.length,e,j;c<d;c++)for(e in b[c])j=b[c][e],b[c].hasOwnProperty(e)&&void 0!==j&&(i.isPlainObject(j)?a[e]=i.isPlainObject(a[e])?i.widget.extend({},a[e],j):i.widget.extend({},j):a[e]=j);return a};i.widget.bridge=function(a,b){var c=b.prototype.widgetFullName||a;i.fn[a]=function(d){var e=
"string"==typeof d,j=z.call(arguments,1),f=this;return d=!e&&j.length?i.widget.extend.apply(null,[d].concat(j)):d,e?this.each(function(){var b,e=i.data(this,c);if(!e)return i.error("cannot call methods on "+a+" prior to initialization; attempted to call method '"+d+"'");if(!i.isFunction(e[d])||"_"===d.charAt(0))return i.error("no such method '"+d+"' for "+a+" widget instance");b=e[d].apply(e,j);if(b!==e&&void 0!==b)return f=b&&b.jquery?f.pushStack(b.get()):b,!1}):this.each(function(){var a=i.data(this,
c);a?a.option(d||{})._init():i.data(this,c,new b(d,this))}),f}};i.Widget=function(){};i.Widget._childConstructors=[];i.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",defaultElement:"<div>",options:{disabled:!1,create:null},_createWidget:function(a,b){b=i(b||this.defaultElement||this)[0];this.element=i(b);this.uuid=C++;this.eventNamespace="."+this.widgetName+this.uuid;this.options=i.widget.extend({},this.options,this._getCreateOptions(),a);this.bindings=i();this.hoverable=i();this.focusable=
...
this.widget().unbind(this.eventNamespace).removeAttr("aria-disabled").removeClass(this.widgetFullName+"-disabled ui-state-disabled");this.bindings.unbind(this.eventNamespace);this.hoverable.removeClass("ui-state-hover");this.focusable.removeClass("ui-state-focus")},_destroy:i.noop,widget:function(){return this.element},option:function(a,b){var c=a,d,e,j;if(0===arguments.length)return i.widget.extend({},this.options);if("string"==typeof a)if(c={},d=a.split("."),a=d.shift(),d.length){e=c[a]=i.widget.extend({},
this.options[a]);for(j=0;j<d.length-1;j++)e[d[j]]=e[d[j]]||{},e=e[d[j]];a=d.pop();if(void 0===b)return void 0===e[a]?null:e[a];e[a]=b}else{if(void 0===b)return void 0===this.options[a]?null:this.options[a];c[a]=b}return this._setOptions(c),this},_setOptions:function(a){for(var b in a)this._setOption(b,a[b]);return this},_setOption:function(a,b){return this.options[a]=b,"disabled"===a&&(this.widget().toggleClass(this.widgetFullName+"-disabled ui-state-disabled",!!b).attr("aria-disabled",b),this.hoverable.removeClass("ui-state-hover"),
this.focusable.removeClass("ui-state-focus")),this},enable:function(){return this._setOption("disabled",!1)},disable:function(){return this._setOption("disabled",!0)},_on:function(a,b,c){var d,e=this;"boolean"!=typeof a&&(c=b,b=a,a=!1);c?(b=d=i(b),this.bindings=this.bindings.add(b)):(c=b,b=this.element,d=this.widget());i.each(c,function(c,f){function g(){if(a||!(!0===e.options.disabled||i(this).hasClass("ui-state-disabled")))return("string"==typeof f?e[f]:f).apply(e,arguments)}"string"!=typeof f&&
(g.guid=f.guid=f.guid||g.guid||i.guid++);var h=c.match(/^(\w+)\s*(.*)$/),k=h[1]+e.eventNamespace;(h=h[2])?d.delegate(h,k,g):b.bind(k,g)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.unbind(b).undelegate(b)},_delay:function(a,b){var c=this;return setTimeout(function(){return("string"==typeof a?c[a]:a).apply(c,arguments)},b||0)},_hoverable:function(a){this.hoverable=this.hoverable.add(a);this._on(a,{mouseenter:function(a){i(a.currentTarget).addClass("ui-state-hover")},
mouseleave:function(a){i(a.currentTarget).removeClass("ui-state-hover")}})},_focusable:function(a){this.focusable=this.focusable.add(a);this._on(a,{focusin:function(a){i(a.currentTarget).addClass("ui-state-focus")},focusout:function(a){i(a.currentTarget).removeClass("ui-state-focus")}})},_trigger:function(a,b,c){var d,e=this.options[a],c=c||{},b=i.Event(b);b.type=(a===this.widgetEventPrefix?a:this.widgetEventPrefix+a).toLowerCase();b.target=this.element[0];if(a=b.originalEvent)for(d in a)d in b||
(b[d]=a[d]);return this.element.trigger(b,c),!(i.isFunction(e)&&!1===e.apply(this.element[0],[b].concat(c))||b.isDefaultPrevented())}};i.each({show:"fadeIn",hide:"fadeOut"},function(a,b){i.Widget.prototype["_"+a]=function(c,d,e){"string"==typeof d&&(d={effect:d});var j,f=d?!0===d||"number"==typeof d?b:d.effect||b:a,d=d||{};"number"==typeof d&&(d={duration:d});j=!i.isEmptyObject(d);d.complete=e;d.delay&&c.delay(d.delay);j&&i.effects&&(i.effects.effect[f]||!1!==i.uiBackCompat&&i.effects[f])?c[a](d):
f!==a&&c[f]?c[f](d.duration,d.easing,e):c.queue(function(b){i(this)[a]();e&&e.call(c[0]);b()})}});!1!==i.uiBackCompat&&(i.Widget.prototype._getCreateOptions=function(){return i.metadata&&i.metadata.get(this.element[0])[this.widgetName]});var l=jQuery,r=!1;l(document).mouseup(function(){r=!1});l.widget("ui.mouse",{version:"1.9.2",options:{cancel:"input,textarea,button,select,option",distance:1,delay:0},_mouseInit:function(){var a=this;this.element.bind("mousedown."+this.widgetName,function(b){return a._mouseDown(b)}).bind("click."+
this.widgetName,function(b){if(!0===l.data(b.target,a.widgetName+".preventClickEvent"))return l.removeData(b.target,a.widgetName+".preventClickEvent"),b.stopImmediatePropagation(),!1});this.started=!1},_mouseDestroy:function(){this.element.unbind("."+this.widgetName);this._mouseMoveDelegate&&l(document).unbind("mousemove."+this.widgetName,this._mouseMoveDelegate).unbind("mouseup."+this.widgetName,this._mouseUpDelegate)},_mouseDown:function(a){if(!r){this._mouseStarted&&this._mouseUp(a);this._mouseDownEvent=
a;var b=this,c=1===a.which,d="string"==typeof this.options.cancel&&a.target.nodeName?l(a.target).closest(this.options.cancel).length:!1;if(!c||d||!this._mouseCapture(a))return!0;(this.mouseDelayMet=!this.options.delay)||(this._mouseDelayTimer=setTimeout(function(){b.mouseDelayMet=!0},this.options.delay));return this._mouseDistanceMet(a)&&this._mouseDelayMet(a)&&(this._mouseStarted=!1!==this._mouseStart(a),!this._mouseStarted)?(a.preventDefault(),!0):(!0===l.data(a.target,this.widgetName+".preventClickEvent")&&
l.removeData(a.target,this.widgetName+".preventClickEvent"),this._mouseMoveDelegate=function(a){return b._mouseMove(a)},this._mouseUpDelegate=function(a){return b._mouseUp(a)},l(document).bind("mousemove."+this.widgetName,this._mouseMoveDelegate).bind("mouseup."+this.widgetName,this._mouseUpDelegate),a.preventDefault(),r=!0,!0)}},_mouseMove:function(a){return!l.ui.ie||9<=document.documentMode||a.button?this._mouseStarted?(this._mouseDrag(a),a.preventDefault()):(this._mouseDistanceMet(a)&&this._mouseDelayMet(a)&&
(this._mouseStarted=!1!==this._mouseStart(this._mouseDownEvent,a),this._mouseStarted?this._mouseDrag(a):this._mouseUp(a)),!this._mouseStarted):this._mouseUp(a)},_mouseUp:function(a){return l(document).unbind("mousemove."+this.widgetName,this._mouseMoveDelegate).unbind("mouseup."+this.widgetName,this._mouseUpDelegate),this._mouseStarted&&(this._mouseStarted=!1,a.target===this._mouseDownEvent.target&&l.data(a.target,this.widgetName+".preventClickEvent",!0),this._mouseStop(a)),!1},_mouseDistanceMet:function(a){return Math.max(Math.abs(this._mouseDownEvent.pageX-
...
-this.scrollParent.scrollTop():e?0:d.scrollTop())*c,left:b.left+this.offset.relative.left*c+this.offset.parent.left*c-("fixed"==this.cssPosition?-this.scrollParent.scrollLeft():e?0:d.scrollLeft())*c}},_generatePosition:function(a){var b=this.options,c="absolute"!=this.cssPosition||this.scrollParent[0]!=document&&f.contains(this.scrollParent[0],this.offsetParent[0])?this.scrollParent:this.offsetParent,d=/(html|body)/i.test(c[0].tagName),e=a.pageX,j=a.pageY;if(this.originalPosition){var g;this.containment&&
(this.relative_container?(g=this.relative_container.offset(),g=[this.containment[0]+g.left,this.containment[1]+g.top,this.containment[2]+g.left,this.containment[3]+g.top]):g=this.containment,a.pageX-this.offset.click.left<g[0]&&(e=g[0]+this.offset.click.left),a.pageY-this.offset.click.top<g[1]&&(j=g[1]+this.offset.click.top),a.pageX-this.offset.click.left>g[2]&&(e=g[2]+this.offset.click.left),a.pageY-this.offset.click.top>g[3]&&(j=g[3]+this.offset.click.top));b.grid&&(j=b.grid[1]?this.originalPageY+
Math.round((j-this.originalPageY)/b.grid[1])*b.grid[1]:this.originalPageY,j=g?j-this.offset.click.top<g[1]||j-this.offset.click.top>g[3]?j-this.offset.click.top<g[1]?j+b.grid[1]:j-b.grid[1]:j:j,e=b.grid[0]?this.originalPageX+Math.round((e-this.originalPageX)/b.grid[0])*b.grid[0]:this.originalPageX,e=g?e-this.offset.click.left<g[0]||e-this.offset.click.left>g[2]?e-this.offset.click.left<g[0]?e+b.grid[0]:e-b.grid[0]:e:e)}return{top:j-this.offset.click.top-this.offset.relative.top-this.offset.parent.top+
...
c.options.helper&&this.instance.currentItem.css({top:"auto",left:"auto"})):(this.instance.cancelHelperRemoval=!1,this.instance._trigger("deactivate",a,d))})},drag:function(a,b){var c=f(this).data("draggable"),d=this;f.each(c.sortables,function(){var e=!1,j=this;this.instance.positionAbs=c.positionAbs;this.instance.helperProportions=c.helperProportions;this.instance.offset.click=c.offset.click;this.instance._intersectsWith(this.instance.containerCache)&&(e=!0,f.each(c.sortables,function(){return this.instance.positionAbs=
c.positionAbs,this.instance.helperProportions=c.helperProportions,this.instance.offset.click=c.offset.click,this!=j&&this.instance._intersectsWith(this.instance.containerCache)&&f.ui.contains(j.instance.element[0],this.instance.element[0])&&(e=!1),e}));e?(this.instance.isOver||(this.instance.isOver=1,this.instance.currentItem=f(d).clone().removeAttr("id").appendTo(this.instance.element).data("sortable-item",!0),this.instance.options._helper=this.instance.options.helper,this.instance.options.helper=
...
d=c.options,e=d.snapTolerance,j=b.offset.left,g=j+c.helperProportions.width,i=b.offset.top,h=i+c.helperProportions.height,k=c.snapElements.length-1;0<=k;k--){var m=c.snapElements[k].left,l=m+c.snapElements[k].width,n=c.snapElements[k].top,p=n+c.snapElements[k].height;if(m-e<j&&j<l+e&&n-e<i&&i<p+e||m-e<j&&j<l+e&&n-e<h&&h<p+e||m-e<g&&g<l+e&&n-e<i&&i<p+e||m-e<g&&g<l+e&&n-e<h&&h<p+e){if("inner"!=d.snapMode){var q=Math.abs(n-h)<=e,s=Math.abs(p-i)<=e,t=Math.abs(m-g)<=e,u=Math.abs(l-j)<=e;q&&(b.position.top=
c._convertPositionTo("relative",{top:n-c.helperProportions.height,left:0}).top-c.margins.top);s&&(b.position.top=c._convertPositionTo("relative",{top:p,left:0}).top-c.margins.top);t&&(b.position.left=c._convertPositionTo("relative",{top:0,left:m-c.helperProportions.width}).left-c.margins.left);u&&(b.position.left=c._convertPositionTo("relative",{top:0,left:l}).left-c.margins.left)}var r=q||s||t||u;"outer"!=d.snapMode&&(q=Math.abs(n-i)<=e,s=Math.abs(p-h)<=e,t=Math.abs(m-j)<=e,u=Math.abs(l-g)<=e,q&&
(b.position.top=c._convertPositionTo("relative",{top:n,left:0}).top-c.margins.top),s&&(b.position.top=c._convertPositionTo("relative",{top:p-c.helperProportions.height,left:0}).top-c.margins.top),t&&(b.position.left=c._convertPositionTo("relative",{top:0,left:m}).left-c.margins.left),u&&(b.position.left=c._convertPositionTo("relative",{top:0,left:l-c.helperProportions.width}).left-c.margins.left));!c.snapElements[k].snapping&&(q||s||t||u||r)&&c.options.snap.snap&&c.options.snap.snap.call(c.element,
a,f.extend(c._uiHash(),{snapItem:c.snapElements[k].item}));c.snapElements[k].snapping=q||s||t||u||r}else c.snapElements[k].snapping&&c.options.snap.release&&c.options.snap.release.call(c.element,a,f.extend(c._uiHash(),{snapItem:c.snapElements[k].item})),c.snapElements[k].snapping=!1}}});f.ui.plugin.add("draggable","stack",{start:function(){var a=f(this).data("draggable").options,a=f.makeArray(f(a.stack)).sort(function(a,b){return(parseInt(f(a).css("zIndex"),10)||0)-(parseInt(f(b).css("zIndex"),10)||
...
this.positionAbs.left,c=b+this.helperProportions.width,d=this.positionAbs.top,e=d+this.helperProportions.height,j=a.left,g=j+a.width,f=a.top,i=f+a.height,h=this.offset.click.top,k=this.offset.click.left;return"pointer"==this.options.tolerance||this.options.forcePointerForContainers||"pointer"!=this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?d+h>f&&d+h<i&&b+k>j&&b+k<g:j<b+this.helperProportions.width/2&&c-this.helperProportions.width/
2<g&&f<d+this.helperProportions.height/2&&e-this.helperProportions.height/2<i},_intersectsWithPointer:function(a){var b="x"===this.options.axis||g.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,a.top,a.height),a="y"===this.options.axis||g.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,a.left,a.width),b=b&&a,a=this._getDragVerticalDirection(),c=this._getDragHorizontalDirection();return b?this.floating?c&&"right"==c||"down"==a?2:1:a&&("down"==a?2:1):!1},_intersectsWithSides:function(a){var b=
g.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,a.top+a.height/2,a.height),a=g.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,a.left+a.width/2,a.width),c=this._getDragVerticalDirection(),d=this._getDragHorizontalDirection();return this.floating&&d?"right"==d&&a||"left"==d&&!a:c&&("down"==c&&b||"up"==c&&!b)},_getDragVerticalDirection:function(){var a=this.positionAbs.top-this.lastPositionAbs.top;return 0!=a&&(0<a?"down":"up")},_getDragHorizontalDirection:function(){var a=this.positionAbs.left-
this.lastPositionAbs.left;return 0!=a&&(0<a?"right":"left")},refresh:function(a){return this._refreshItems(a),this.refreshPositions(),this},_connectWith:function(){var a=this.options;return a.connectWith.constructor==String?[a.connectWith]:a.connectWith},_getItemsAsjQuery:function(a){var b=[],c=[],d=this._connectWith();if(d&&a)for(a=d.length-1;0<=a;a--)for(var e=g(d[a]),j=e.length-1;0<=j;j--){var f=g.data(e[j],this.widgetName);f&&f!=this&&!f.options.disabled&&c.push([g.isFunction(f.options.items)?
...
a,this._uiHash(this)),this.containers[c].containerCache.over=1;else{for(var b=1E4,d=null,e=this.containers[c].floating?"left":"top",f=this.containers[c].floating?"width":"height",i=this.positionAbs[e]+this.offset.click[e],h=this.items.length-1;0<=h;h--)if(g.contains(this.containers[c].element[0],this.items[h].item[0])&&this.items[h].item[0]!=this.currentItem[0]){var k=this.items[h].item.offset()[e],l=!1;Math.abs(k-i)>Math.abs(k+this.items[h][f]-i)&&(l=!0,k+=this.items[h][f]);Math.abs(k-i)<b&&(b=Math.abs(k-
i),d=this.items[h],this.direction=l?"up":"down")}if(d||this.options.dropOnEmpty)this.currentContainer=this.containers[c],d?this._rearrange(a,d,null,!0):this._rearrange(a,null,this.containers[c].element,!0),this._trigger("change",a,this._uiHash()),this.containers[c]._trigger("change",a,this._uiHash(this)),this.options.placeholder.update(this.currentContainer,this.placeholder),this.containers[c]._trigger("over",a,this._uiHash(this)),this.containers[c].containerCache.over=1}},_createHelper:function(a){var b=
...
""));this.range=k([]);c.range&&(!0===c.range&&(c.values||(c.values=[this._valueMin(),this._valueMin()]),c.values.length&&2!==c.values.length&&(c.values=[c.values[0],c.values[0]])),this.range=k("<div></div>").appendTo(this.element).addClass("ui-slider-range ui-widget-header"+("min"===c.range||"max"===c.range?" ui-slider-range-"+c.range:"")));b=c.values&&c.values.length||1;for(a=d.length;a<b;a++)e.push("<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>");this.handles=d.add(k(e.join("")).appendTo(this.element));
this.handle=this.handles.eq(0);this.handles.add(this.range).filter("a").click(function(a){a.preventDefault()}).mouseenter(function(){c.disabled||k(this).addClass("ui-state-hover")}).mouseleave(function(){k(this).removeClass("ui-state-hover")}).focus(function(){c.disabled?k(this).blur():(k(".ui-slider .ui-state-focus").removeClass("ui-state-focus"),k(this).addClass("ui-state-focus"))}).blur(function(){k(this).removeClass("ui-state-focus")});this.handles.each(function(a){k(this).data("ui-slider-handle-index",
a)});this._on(this.handles,{keydown:function(a){var b,c,d,e=k(a.target).data("ui-slider-handle-index");switch(a.keyCode){case k.ui.keyCode.HOME:case k.ui.keyCode.END:case k.ui.keyCode.PAGE_UP:case k.ui.keyCode.PAGE_DOWN:case k.ui.keyCode.UP:case k.ui.keyCode.RIGHT:case k.ui.keyCode.DOWN:case k.ui.keyCode.LEFT:if(a.preventDefault(),!this._keySliding&&(this._keySliding=!0,k(a.target).addClass("ui-state-active"),b=this._start(a,e),!1===b))return}b=this.options.step;this.options.values&&this.options.values.length?
c=d=this.values(e):c=d=this.value();switch(a.keyCode){case k.ui.keyCode.HOME:d=this._valueMin();break;case k.ui.keyCode.END:d=this._valueMax();break;case k.ui.keyCode.PAGE_UP:d=this._trimAlignValue(c+(this._valueMax()-this._valueMin())/5);break;case k.ui.keyCode.PAGE_DOWN:d=this._trimAlignValue(c-(this._valueMax()-this._valueMin())/5);break;case k.ui.keyCode.UP:case k.ui.keyCode.RIGHT:if(c===this._valueMax())return;d=this._trimAlignValue(c+b);break;case k.ui.keyCode.DOWN:case k.ui.keyCode.LEFT:if(c===
this._valueMin())return;d=this._trimAlignValue(c-b)}this._slide(a,e,d)},keyup:function(a){var b=k(a.target).data("ui-slider-handle-index");this._keySliding&&(this._keySliding=!1,this._stop(a,b),this._change(a,b),k(a.target).removeClass("ui-state-active"))}});this._refreshValue();this._animateOff=!1},_destroy:function(){this.handles.remove();this.range.remove();this.element.removeClass("ui-slider ui-slider-horizontal ui-slider-vertical ui-slider-disabled ui-widget ui-widget-content ui-corner-all");
this._mouseDestroy()},_mouseCapture:function(a){var b,c,d,e,f,g,h,i,l=this,m=this.options;return m.disabled?!1:(this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()},this.elementOffset=this.element.offset(),b={x:a.pageX,y:a.pageY},c=this._normValueFromMouse(b),d=this._valueMax()-this._valueMin()+1,this.handles.each(function(a){var b=Math.abs(c-l.values(a));d>b&&(d=b,e=k(this),f=a)}),!0===m.range&&this.values(1)===m.min&&(f+=1,e=k(this.handles[f])),g=this._start(a,f),
!1===g?!1:(this._mouseSliding=!0,this._handleIndex=f,e.addClass("ui-state-active").focus(),h=e.offset(),i=!k(a.target).parents().andSelf().is(".ui-slider-handle"),this._clickOffset=i?{left:0,top:0}:{left:a.pageX-h.left-e.width()/2,top:a.pageY-h.top-e.height()/2-(parseInt(e.css("borderTopWidth"),10)||0)-(parseInt(e.css("borderBottomWidth"),10)||0)+(parseInt(e.css("marginTop"),10)||0)},this.handles.hasClass("ui-state-hover")||this._slide(a,f,c),this._animateOff=!0,!0))},_mouseStart:function(){return!0},
...
b,c,d,e,f=this.options.range,g=this.options,h=this,i=this._animateOff?!1:g.animate,l={};this.options.values&&this.options.values.length?this.handles.each(function(c){b=100*((h.values(c)-h._valueMin())/(h._valueMax()-h._valueMin()));l["horizontal"===h.orientation?"left":"bottom"]=b+"%";k(this).stop(1,1)[i?"animate":"css"](l,g.animate);!0===h.options.range&&("horizontal"===h.orientation?(0===c&&h.range.stop(1,1)[i?"animate":"css"]({left:b+"%"},g.animate),1===c&&h.range[i?"animate":"css"]({width:b-a+
"%"},{queue:!1,duration:g.animate})):(0===c&&h.range.stop(1,1)[i?"animate":"css"]({bottom:b+"%"},g.animate),1===c&&h.range[i?"animate":"css"]({height:b-a+"%"},{queue:!1,duration:g.animate})));a=b}):(c=this.value(),d=this._valueMin(),e=this._valueMax(),b=e!==d?100*((c-d)/(e-d)):0,l["horizontal"===this.orientation?"left":"bottom"]=b+"%",this.handle.stop(1,1)[i?"animate":"css"](l,g.animate),"min"===f&&"horizontal"===this.orientation&&this.range.stop(1,1)[i?"animate":"css"]({width:b+"%"},g.animate),"max"===
f&&"horizontal"===this.orientation&&this.range[i?"animate":"css"]({width:100-b+"%"},{queue:!1,duration:g.animate}),"min"===f&&"vertical"===this.orientation&&this.range.stop(1,1)[i?"animate":"css"]({height:b+"%"},g.animate),"max"===f&&"vertical"===this.orientation&&this.range[i?"animate":"css"]({height:100-b+"%"},{queue:!1,duration:g.animate}))}})});;
...
;JCSDL.Loader.addComponent(function(b){function h(a){if(a.attr("title")||"string"!=typeof a.attr("original-title"))a.attr("original-title",a.attr("title")||"").removeAttr("title")}function i(a,c){this.$element=b(a);this.options=c;this.enabled=!0;h(this.$element)}i.prototype={show:function(){var a=this.getTitle();if(a&&this.enabled){var c=this.tip();c.find(".tipsy-inner")[this.options.html?"html":"text"](a);c[0].className="tipsy";c.remove().css({top:0,left:0,visibility:"hidden",display:"block"}).appendTo(document.body);
...
;JCSDL.Loader.addComponent(function(g,j){this.Parser=function(a){this.gui=a};this.Parser.prototype={v:"2.0",parseJCSDL:function(a){var b=a.split("\n"),d=b.shift();b.pop();if(!this.verifyJCSDL(d,b))throw new JCSDL.ValidationException("The given JCSDL did not verify!",a);b.shift();a=d.split(" ")[3];d=[];for("//"!==b[0].substr(0,2)&&b.shift();1<b.length;){var c=b.shift(),e=b.shift();b.shift();b.shift();var c=c.split(" "),f=c[3],g=c[4]||d.length+1;if(!this.verifyJCSDLFilter(c[2],e))throw new JCSDL.ValidationException("The given JCSDL Filter code did not verify!",
e);c=this.filterFromJCSDL(f,e,g);d.push(c)}return{filters:d,logic:a}},filterFromJCSDL:function(a,b,d){var a=a.split(","),c=a.shift().split("."),e=c.shift(),f=this.getFieldInfo(e,c);if(!1===f)return!1;var h=a.shift(),i="",k={cs:!1};"exists"!==h&&(i=a.shift().split("-"),i=this.valueFromCSDL(f,b.substr(i[0],i[1]),h),g.each(a,function(a,b){switch(b){case "cs":k.cs=!0}}));return this.createFilter(e,c,h,i,k,d)},getJCSDLForFilters:function(a,b){var d=this,c={},e=[],f="";g.each(a,function(a,b){var e=d.filterToCSDL(b);
if(!e)return!0;c[b.id+""]=e});if("AND"!=b&&"OR"!=b){var f=this.tokenizeLogicString(b),h="";this.validateLogic(f,a);g.each(f,function(a,b){if("number"===typeof b)if(h.length&&e.push(g.trim(h)),h="",c[b+""]!==j)e.push(c[b+""]);else throw new JCSDL.LogicValidationException("A filter with ID '"+b+"' doesn't exist! You cannot use it in a logical expression",a);else h="&"==b||"|"==b?h+("|"==b?" OR ":" AND "):h+b});h.length&&e.push(g.trim(h));f=e.join("\n")}else g.each(c,function(b,a){e.push(a)}),f=e.join("\n"+
b+"\n");f="// JCSDL_VERSION "+this.v+"\n"+f;return f="// JCSDL_MASTER "+this.encodeJCSDL(f,b)+" "+b+"\n"+f+"\n// JCSDL_MASTER_END"},filterToCSDL:function(a){var b=this.getFieldInfo(a.target,a.fieldPath);if(!1===b)return!1;var d=this.valueToCSDL(a.value,b,a.operator);if(!1===d)return!1;var c=this.fieldToCSDL(a.fieldPath);if(!1===c)return!1;var e=this.getOperatorCode(a.operator);if(!1===e)return!1;var f=a.cs?" cs":"",e=("augmentation"==a.target?"":a.target+".")+c.replace("-",".")+f+" "+e+" ",c=a.target+
"."+c+","+a.operator;"exists"!==a.operator&&(f="string"==b.type||"geo"==b.type?e.length+1:e.length,b="string"==b.type||"geo"==b.type?d.length-2:d.length,e+=d,c+=","+f+"-"+b,a.cs&&(c+=",cs"));return[["// JCSDL_START",this.encodeJCSDLFilter(e),c,a.id].join(" "),e,"// JCSDL_END"].join("\n")},encodeJCSDL:function(a,b){return Crypto.MD5(b+"\n"+a)},verifyJCSDL:function(a,b){var d=b.join("\n"),c=a.split(" "),e=c[2],d=this.encodeJCSDL(d,c[3]);return e==d},encodeJCSDLFilter:function(a){return Crypto.MD5(a)},
verifyJCSDLFilter:function(a,b){return a==this.encodeJCSDLFilter(b)},fieldToCSDL:function(a){return a.join(".")},valueToCSDL:function(a,b,d){var c="";if("int"==b.type||"float"==b.type){if("in"!==d&&isNaN(a))return this.error("This field value is suppose to be a Number, String given.",a,b),!1;"in"==d?(a=a.split(","),g.each(a,function(b,c){a[b]=parseInt(c)}),c="["+a.join(",")+"]"):c=a}else b=0<=g.inArray(d,["regex_partial","regex_exact"])?!0:!1,c='"'+a.escapeCsdl(b)+'"';return c},valueFromCSDL:function(a,
b,d){if("int"==a.type)return"in"==d&&(b=b.substr(1,b.length-2)),b;a=0<=g.inArray(d,["regex_partial","regex_exact"])?!0:!1;return b.unescapeCsdl(a)},tokenizeLogicString:function(a){for(var a=(""+a).replace(/\s+/g,""),b=[],d=!1,c=0;c<a.length;c++){var e=a.charAt(c);e.isNumeric()?(d?(b[b.length-1]+=""+e,b[b.length-1]=parseInt(b[b.length-1])):b.push(parseInt(e)),d=!0):(b.push(e),d=!1)}return b},validateLogic:function(a,b){var d="string"===typeof a||"number"===typeof a?this.tokenizeLogicString(a):a;if(0<=
g.inArray(d[0],["&","|"]))throw new JCSDL.LogicValidationException('Logical query cannot start with logical operator "'+d[0]+'"!',0);if(0<=g.inArray(d[d.length-1],["&","|"]))throw new JCSDL.LogicValidationException('Logical query cannot end with logical operator "'+d[d.length-1]+'"!',d.length-1);var c=null,e=[],f=0,h=[];b&&b.length&&g.each(b,function(b,a){h.push(parseInt(a.id))});g.each(d,function(b,a){if("("==a&&")"==c)throw new JCSDL.LogicValidationException('You cannot use opening parenthesis "(" right after a closing parenthesis ")"!',
b);if(")"==a&&"("==c)throw new JCSDL.LogicValidationException('You cannot use closing parenthesis ")" right after an opening parenthesis "("!',b);if(")"==a&&0<=g.inArray(c,["&","|"]))throw new JCSDL.LogicValidationException('You cannot use closing parenthesis ")" right after a logical operator!',b);if(0<=g.inArray(a,["&","|"])&&"("==c)throw new JCSDL.LogicValidationException('You cannot use logical operator "'+a+'" right after opening brackets!',b);if("("==a&&"number"==typeof c)throw new JCSDL.LogicValidationException('You cannot open a parenthesis right after filter ID! You need to use a logical operator "&" or "|"!',
b);if("number"==typeof a&&")"==c)throw new JCSDL.LogicValidationException('You cannot use filter ID right after closing a parenthesis! You need to use a logical operator "&" or "|"!',b);if(0<=g.inArray(a,["&","|"])&&0<=g.inArray(c,["&","|"]))throw new JCSDL.LogicValidationException("You cannot use two logical operators next to each other!",b);if("number"==typeof a){if("number"==typeof c)throw new JCSDL.LogicValidationException("Cannot use two filter ID's next to each other!",b);if(-1==g.inArray(a,
h))throw new JCSDL.LogicValidationException('The filter ID "'+a+"\" doesn't exist! You can only use filters from the list of filters.",b);if(0<=g.inArray(a,e))throw new JCSDL.LogicValidationException('The filter with ID "'+a+'" has already been used in the logical expression! You can only use one filter once.',b);e.push(a)}if(0<=g.inArray(a,["(",")"])&&(f="("==a?f+1:f-1,0>f))throw new JCSDL.LogicValidationException("Parentheses do not create a logical expression, i.e. there are too many closing parenthesis that close a nested expression that was never opened!",
b);c=a});var i=[];g.each(h,function(a,b){-1==g.inArray(b,e)&&i.push(b)});if(i.length)throw new JCSDL.LogicValidationException("You haven't used some of the filters in your logical expression (with ID's: \""+i.join('", "')+'"). All filters need to be used!');if(0!==f)throw new JCSDL.LogicValidationException("You have't closed some parentheses!");return!0},error:function(a,b){this.gui.showError.apply(this.gui,arguments)},createFilter:function(a,b,d,c,e,f){e=e||{};return{id:f,target:a,fieldPath:b,operator:d,
value:c,cs:e.cs}},getOperatorCode:function(a){return this.gui.definition.operators[a].code},getTargetInfo:function(a){if(this.gui.definition.targets[a]!==j)return this.gui.definition.targets[a];this.error("Such target does not exist!",a);return!1},getFieldInfo:function(a,b){var d=this,c=this.gui.definition.targets[a];if(c===j)return this.error("Such target does not exist!",a),!1;g.each(b,function(e,f){if(c.fields!==j)if(c.fields[f]!==j)c=c.fields[f];else return d.error("Invalid path to a field (#1)!",
a,b,c),c=!1;else return d.error("Invalid path to a field (#2)!",a,b,c),c=!1});return c}};this.ValidationException=function(a,b){this.message=a;this.code=b};this.LogicValidationException=function(a,b){this.message=a;this.index=b}});;
;JCSDL.Loader.addComponent(function(a){this.GUITemplates={container:a('<div class="jcsdl-container" />'),editor:a('<div class="jcsdl-mainview"><div class="jcsdl-header"><div class="jcsdl-row"><h3>Filters</h3><div class="jcsdl-actions"><a href="#" class="jcsdl-button jcsdl-elements-sprite jcsdl-editor-save">Save and Preview</a><a href="#" class="jcsdl-button jcsdl-elements-sprite jcsdl-editor-cancel">Cancel</a></div></div><div class="jcsdl-advanced-container jcsdl-bordered" style="display: none;"><div class="jcsdl-advanced-gui-container"><ul class="jcsdl-advanced-gui" /><a href="#" class="jcsdl-advanced-gui-arrow left off"><span class="jcsdl-elements-sprite" /></a><a href="#" class="jcsdl-advanced-gui-arrow right off"><span class="jcsdl-elements-sprite" /></a></div><div class="jcsdl-advanced-manual" style="display: none;"><input type="text" name="advanced" placeholder="1&(2|3)..." /></div></div><div class="jcsdl-row"><div class="jcsdl-filters-logic"><a href="#" class="jcsdl-bordered jcsdl-filters-logic-option jcsdl-and active disabled" data-logic="AND" data-text-long="ALL of the following" data-text-short="ALL">ALL of the following</a><a href="#" class="jcsdl-bordered jcsdl-filters-logic-option jcsdl-or disabled" data-logic="OR" data-text-long="ANY of the following" data-text-short="ANY">ANY of the following</a><a href="#" class="jcsdl-bordered jcsdl-filters-logic-option jcsdl-advanced disabled" data-logic="ADVANCED">ADVANCED<span class="jcsdl-logic-help" data-text-general="Use the advanced option to create logical expressions." data-text-gui="Drag and drop the tiles to create an advanced query." data-text-manual="Type a logical expression to create an advanced query.">?</span></a><a href="#" class="jcsdl-bordered jcsdl-filters-logic-option jcsdl-advanced-option jcsdl-advanced-add-brackets">+ [ ]</a><a href="#" class="jcsdl-bordered jcsdl-filters-logic-option jcsdl-advanced-option jcsdl-advanced-manual-edit" data-text-gui="Manual Edit" data-text-manual="Graphical Edit">Manual Edit</a></div><div class="jcsdl-mainview-actions"><a href="#" class="jcsdl-bordered jcsdl-mainview-action jcsdl-add-filter"><div class="jcsdl-picto jcsdl-elements-sprite"></div>Create New Filter</a></div><div class="jcsdl-mainview-mode"><div class="jcsdl-label">View as:</div><div class="jcsdl-bordered jcsdl-mainview-mode-options"><a href="#" class="jcsdl-mainview-mode-option jcsdl-elements-sprite jcsdl-expanded active" data-mode="expanded"></a><a href="#" class="jcsdl-mainview-mode-option jcsdl-elements-sprite jcsdl-collapsed" data-mode="collapsed"></a></div></div></div></div><div class="jcsdl-filters-list expanded"></div><div class="jcsdl-footer"><div class="jcsdl-actions"><a href="#" class="jcsdl-button jcsdl-elements-sprite jcsdl-editor-save">Save and Preview</a><a href="#" class="jcsdl-button jcsdl-elements-sprite jcsdl-editor-cancel">Cancel</a></div><div class="jcsdl-mainview-actions"><a href="#" class="jcsdl-bordered jcsdl-mainview-action jcsdl-add-filter"><div class="jcsdl-picto jcsdl-elements-sprite"></div>Create New Filter</a></div></div></div>'),
...
valueInput_text:a('<div class="jcsdl-input-text"><input type="text" placeholder="Type your desired value..." class="orig" /><div class="jcsdl-containsnear-distance"><span>Distance:</span><input type="text" placeholder="e.g. 0" value="2" class="dist" /></div></div>'),valueInput_number:a('<div class="jcsdl-input-number"><input type="text" placeholder="e.g. 3.14" /></div>'),valueInput_select:a('<div class="jcsdl-input-select" />'),valueInput_select_option:a('<a href="#" class="jcsdl-input-select-option"><span /></a>'),
...
0<=i.inArray("in",b.operators),d=a.find("input[type=text]");d.jcsdlNumberMask(c);b&&d.jcsdlTagInput({numbers:!0,floats:c});return a},setValue:function(b,a,c){b.find("input[type=text]:first").val(c)},getValue:function(b){return b.find("input[type=text]:first").val()},displayValue:function(b,a,c){if("in"!==c.operator)return a;var d="float"==b.type,a=a.split(","),e=a.slice(0,3);i.each(e,function(a,c){e[a]=d?parseFloat(c).format(2):c});b=e.length<a.length?" and "+(a.length-e.length)+" more...":"";return e.join(", ")+
b}},select:{init:function(b){var a=this,c=this.getTemplate("valueInput_select"),d=this.exec("select","getOptionsSet",[b]);i.each(d,function(b,d){a.exec("select","createOptionView",[b,d]).appendTo(c)});c.find(".jcsdl-input-select-option").bind("click touchstart",function(a){a.preventDefault();a.target.blur();b.single&&c.find(".jcsdl-input-select-option").removeClass("selected");i(this).toggleClass("selected")});return c},setValue:function(b,a,c){a=c.split(",");i.each(a,function(a,c){b.find(".jcsdl-input-select-option.option-"+
c).addClass("selected")})},getValue:function(b){var a=[];b.find(".jcsdl-input-select-option.selected").each(function(c,b){a.push(i(b).data("value"))});return a.join(",")},displayValue:function(b,a){var c=this,d=a.split(","),e=this.getTemplate("valueInput_select");if(0==d.length)return e;var f=this.exec("select","getOptionsSet",[b]),h=d.slice(0,5);i.each(h,function(a,b){if(f[b]===l)return!0;c.exec("select","createOptionView",[b,f[b]]).addClass("selected").appendTo(e)});if(d.length>h.length){var g=
this.getTemplate("valueInput_select_more");g.find(".count").html(d.length-h.length);g.appendTo(e)}e.find(".jcsdl-input-select-option").bind("click touchstart",function(a){a.preventDefault();a.target.blur()});return e},getOptionsSet:function(b){var a={};b.options!==l?a=b.options:b.optionsSet!==l&&this.definition.inputs.select.sets[b.optionsSet]!==l&&(a=this.definition.inputs.select.sets[b.optionsSet]);return a},createOptionView:function(b,a){var c=this.getTemplate("valueInput_select_option").data("value",
...
[b,d.min]));c.find(".jcsdl-slider-label.max").html(this.exec("slider","displayValue",[b,d.max]));c.find(".jcsdl-slider-input").jcsdlNumberMask("float"==b.type).keyup(function(d){110==d.which||190==d.which||(d=i(this).val(),a.exec("slider","setValue",[c,b,parseFloat(d?d:0)]))});var e=null;c.find(".jcsdl-slider-minus, .jcsdl-slider-plus").bind("mousedown touchstart",function(){var f=i(this).is(".jcsdl-slider-minus");e=setInterval(function(){var e=d.step,g=parseFloat(c.find(".jcsdl-slider-input").val()),
...
"getOptions",[b]);return c.displayFormat.apply(c,[a.toString()])},parseValue:function(b,a){return a},getOptions:function(b){return i.extend({},this.definition.inputs.slider,{min:b.min,max:b.max,step:b.step,"default":b["default"],displayFormat:b.displayFormat})}},_geo:{mapOptions:{},initSearch:function(b){var a=b.data("map"),c=b.find(".jcsdl-map-search"),d=new google.maps.places.Autocomplete(c[0],{});google.maps.event.addListener(d,"place_changed",function(){var b=d.getPlace();b.geometry===l?0<i(".pac-container .pac-item").length&&
...
i(this).hide()})},setValue:function(b,a,c){var d=this,e=b.find(".jcsdl-input-geo"),c=c.split(":"),f=c[0].split(","),h=c[1].split(",");setTimeout(function(){var a=e.data("map"),c=e.data("rect"),j=d.exec("geo_box","getAllTipsFromNWSE",[f,h]),k=new google.maps.LatLngBounds(j.sw,j.ne);d.exec("geo_box","drawRectangleFromBounds",[a,c,k]);k=e.data("markers");k[0].setMap(a);k[0].setPosition(j.ne);k[1].setMap(a);k[1].setPosition(j.sw);a.fitBounds(c.getBounds());d.exec("geo_box","updateInfo",[e,c]);b.find(".jcsdl-map-instructions").html(d.definition.inputs.geo_box.instructions[2]);
b.find(".jcsdl-clear-map").fadeIn()},this.gui.config.animate+200)},getValue:function(b){b=b.find(".jcsdl-input-geo").data("rect");if(!b.getMap())return"";b=this.exec("geo_box","getAllTipsFromBounds",[b.getBounds()]);return b.nw.lat()+","+b.nw.lng()+":"+b.se.lat()+","+b.se.lng()},displayValue:function(b,a){var a=a.split(":"),c=a[0].split(","),d=a[1].split(",");return parseFloat(c[0]).format(2)+", "+parseFloat(c[1]).format(2)+" : "+parseFloat(d[0]).format(2)+", "+parseFloat(d[1]).format(2)},drawRectangle:function(b,
...
h.setPosition(b.latLng),h.setMap(d),a.data("center",!0),a.find(".jcsdl-map-instructions").html(c.definition.inputs.geo_radius.instructions[1]);a.find(".jcsdl-clear-map").fadeIn()});google.maps.event.addListener(h,"position_changed",function(){var a=this.getPosition(),b=f.getCenter();f.setCenter(a);if(b!==l){var c=a.lat()-b.lat(),a=a.lng()-b.lng(),b=g.getPosition(),c=new google.maps.LatLng(b.lat()+c,b.lng()+a);g.setPosition(c)}});google.maps.event.addListener(g,"position_changed",function(){f.getCenter()!==
l&&(f.setRadius(google.maps.geometry.spherical.computeDistanceBetween(f.getCenter(),this.getPosition())),c.exec("geo_radius","updateInfo",[a,f]))});a.find(".jcsdl-clear-map").bind("click touchstart",function(b){b.preventDefault();b.target.blur();f.setCenter(null);f.setMap(null);h.setMap(null);g.setMap(null);a.data("center",!1);a.find(".jcsdl-map-area span").html("0 km<sup>2</sup>");a.find(".jcsdl-map-instructions").html(c.definition.inputs.geo_radius.instructions[0]);i(this).hide()})},setValue:function(b,
a,c){var d=this,e=b.find(".jcsdl-input-geo"),c=c.split(":"),f=c[0].split(","),h=1E3*parseFloat(c[1]);setTimeout(function(){var a=e.data("map"),c=e.data("circle"),j=new google.maps.LatLng(f[0],f[1]),k=e.data("centerMarker");k.setPosition(j);k.setMap(a);var k=e.data("radiusMarker"),i=google.maps.geometry.spherical.computeOffset(j,h,90);k.setPosition(i);k.setMap(a);c.setCenter(j);c.setRadius(h);c.setMap(a);e.data("center",!0);a.fitBounds(c.getBounds());d.exec("geo_radius","updateInfo",[e,c]);b.find(".jcsdl-map-instructions").html(d.definition.inputs.geo_radius.instructions[2]);
b.find(".jcsdl-clear-map").fadeIn()},this.gui.config.animate+200)},getValue:function(b){b=b.find(".jcsdl-input-geo").data("circle");if(!b.getMap())return"";var a=b.getCenter();return a.lat()+","+a.lng()+":"+b.getRadius()/1E3},displayValue:function(b,a){var a=a.split(":"),c=a[0].split(","),d=a[1];return"Center: "+parseFloat(c[0]).format(2)+", "+parseFloat(c[1]).format(2)+"; Radius: "+parseFloat(d).format(2)+" km"},updateInfo:function(b,a){var c=a.getRadius(),c=c*c*Math.PI;b.find(".jcsdl-map-area span").html(Math.round(c/
...
g.forEach(function(a){a.setMap(null)});g.clear();h.clear();c.exec("geo_polygon","updateInfo",[a,f]);a.find(".jcsdl-map-instructions").html(c.definition.inputs.geo_polygon.instructions[0]);i(this).hide()})},setValue:function(b,a,c){var d=this,e=b.find(".jcsdl-input-geo"),c=c.split(":");setTimeout(function(){var a=e.data("polygon"),h=e.data("map");i.each(c,function(b,c){var c=c.split(","),d=new google.maps.LatLng(parseFloat(c[0]),parseFloat(c[1]));a.getPath().push(d)});h.fitBounds(a.getBounds());d.exec("geo_polygon",
"updateInfo",[e,a]);b.find(".jcsdl-map-instructions").html(d.definition.inputs.geo_polygon.instructions[3]);b.find(".jcsdl-clear-map").fadeIn()},this.gui.config.animate+200)},getValue:function(b){var a=[];b.find(".jcsdl-input-geo").data("polygon").getPath().forEach(function(b){a.push(b.lat()+","+b.lng())});return a.join(":")},displayValue:function(b,a){var a=a.split(":"),c=[];i.each(a,function(a,b){b=b.split(",");c.push(parseFloat(b[0]).format(2)+", "+parseFloat(b[1]).format(2));if(1==a)return!1});
c=c.join(" : ");2<a.length&&(c+=" and "+(a.length-2)+" more...");return c},getMarkerIndex:function(b,a){var c=-1;a.forEach(function(a,e){a.getZIndex()==b.getZIndex()&&(c=e)});return c},updateInfo:function(b,a){var c=a.getPath(),d=b.find(".jcsdl-map-coordinates ul").html("");c.forEach(function(a){i("<li />").html("("+a.lat().format(4)+", "+a.lng().format(4)+")").appendTo(d)});3<=c.getLength()?(c=google.maps.geometry.spherical.computeArea(c),b.find(".jcsdl-map-area span").html(Math.round(c/1E6).format()+
...
c.target.blur();var g=b(this),e=!1,f="touchmove"==c.type?c.originalEvent.targetTouches[0].pageX:c.pageX;b("body").bind("mousemove.jcsdlcarousel touchmove.jcsdlcarousel",function(a){e=!0;var a="touchmove"==a.type?a.originalEvent.targetTouches[0].pageX:a.pageX,b=parseInt(d.$carousel.css("left"));d.$carousel.css("left",b-(f-a));f=a});b("body").bind("mouseup.jcsdlcarousel touchend.jcsdlcarousel",function(){e?d.snapToSelection():(d.selectedIndex=g.prevAll(":visible").length,d.changePosition(a.speed),e=
...
JCSDL.Loader.addComponent(function(b,f){b.fn.animateIntoView=function(e,a,d){var e=e===f?200:e,a=parseInt(a)||0,d="function"==typeof d?d:function(){},c=b(this[0]);if(!c.length)return this;var g=b("body"),i=b("html"),c=c.offset().top,h=parseInt(g.scrollTop()),j=h+b(window).height();if(h<c&&c<j)return this;g.add(i).animate({scrollTop:c-a},e,d);return this}});
...
'"')},escapeCsdl:function(){return this.replace(/\\(?![,:]+)/g,"\\\\").replace(/"/g,'\\"')},unescapeCsdl:function(){return this.replace(/\\"/g,'"').replace(/\\\\/g,"\\")}});b.extend(Number.prototype,{format:function(b,a,d){var c=this.toString().replace(/[^0-9+\-Ee.]/g,""),c=!isFinite(+c)?0:+c,b=!isFinite(+b)?0:Math.abs(b),d=d===f?",":d,a=a===f?".":a,g="",g=function(a,b){var c=Math.pow(10,b);return""+Math.round(a*c)/c},g=(b?g(c,b):""+Math.round(c)).split(".");3<g[0].length&&(g[0]=g[0].replace(/\B(?=(?:\d{3})+(?!\d))/g,
d));if((g[1]||"").length<b)g[1]=g[1]||"",g[1]+=Array(b-g[1].length+1).join("0");return g.join(a)}})});;
;JCSDL.Loader.addComponent(function(f,i){this.GUIFilterEditor=function(a,b,c){var b=b||f(),c=c||{},d=this;this.gui=a;this.config=a.config;this.definition=a.definition;this.parser=a.parser;this.inputs=a.inputs;this.getTemplate=a.getTemplate;this.getIconForField=a.getIconForField;this.filter=c;this.steps=[];this.target=null;this.path=[];this.$view=this.getTemplate("filterEditor");this.$steps=this.$view.find(".jcsdl-steps");this.$view.appendTo(b).show();this.addFilterStep("target",this.createTargetSelectView());
...
loadFilter:function(a){var b=this;this.filter=a;if(a===i||!a||a.target===i)return!1;var c=this.parser.getFieldInfo(a.target,a.fieldPath);this.$view.find(".jcsdl-filter-target .target-"+a.target).trigger("jcsdlclick");f.each(a.fieldPath,function(a,c){b.$view.find(".jcsdl-filter-target-field:last").find(".field-"+c).trigger("jcsdlclick")});"string"!==typeof c.input&&this.$view.find(".jcsdl-filter-target-field-input .input-"+a.operator).trigger("jcsdlclick");"text"==c.input?f(".jcsdl-dropdown .jcsdl-dropdown-option.operator-"+
a.operator).click():this.$view.find(".jcsdl-filter-value-input-operators .operator-"+a.operator).click();var d=this.$view.find(".jcsdl-filter-value-input-field");this.setValueForField(d,c,a.value,a.operator);a.cs&&this.$view.find(".jcsdl-operator-cs").click()},addFilterStep:function(a,b,c){var d=this,c=c===i?!0:c,e=this.getTemplate("step"),h=this.steps.length;e.html(b).data("number",h).addClass("jcsdl-filter-step-number-"+h).data("name",a).addClass("jcsdl-filter-step-"+a).appendTo(this.$steps);"target"==
a&&e.jcsdlCarousel({select:function(){var a=f(this);e.addClass("selected").find(".jcsdl-carousel-item.selected").removeClass("selected");a.addClass("selected");d.didSelectTarget(a.data("name"))}});"field"==a&&e.jcsdlCarousel({select:function(){var a=f(this);d.$steps.find(".jcsdl-filter-step-target").addClass("field-selected");var c=e.data("number")-1;d.$steps.find(".jcsdl-filter-step-field.jcsdl-filter-step-number-"+c).addClass("field-selected");e.addClass("selected").find(".jcsdl-carousel-item.selected").removeClass("selected");
...
c.prependTo(this.$view.find(".jcsdl-footer")).hide().fadeIn();console!==i&&console.error(a,arguments)},trigger:function(a,b){this.gui.trigger(a,b)},createTargetSelectView:function(){var a=this,b=this.getTemplate("target"),c=b.find(".jcsdl-filter-target");f.each(this.definition.targets,function(b,e){a.createOptionForTarget(b,e).appendTo(c)});return b},createOptionForTarget:function(a,b){var c=this.getTemplate("targetOption").data("name",a).data("target",b).addClass("target-"+a);0<=f.inArray(a,this.config.hideTargets)&&
(c.addClass("jcsdl-option-hidden"),(this.filter.target===i||this.filter.target!==a)&&c.hide());return c},createFieldSelectionView:function(a){var b=this,c=this.path.length,d=this.target+(0<this.path.length?"."+this.path.join("."):""),e=this.getTemplate("field"),h=!1,g=f.merge([this.target],this.path),j="";e.data("position",c).addClass("field-select-"+c);f.each(g,function(a,c){j=j+(0<a?".":"")+c;if(0<=f.inArray(j,b.config.hideTargets))return h=!0});var i=e.find(".jcsdl-filter-target-field");f.each(a,
function(a,c){b.createOptionForField(a,c,d,h).appendTo(i)});return e},createOptionForField:function(a,b,c,d){var e=this,b=this.getTemplate("fieldOption").data("name",a).data("field",b).html(b.name).addClass("icon-"+this.getIconForField(a,b)).addClass("field-"+a);if(!d){var h=c+"."+a;if(0<=f.inArray(h,e.config.hideTargets))d=!0;else{var h=h.split("-"),g="";f.each(h,function(a,b){g+=(0<a?".":"")+b;if(0<=f.inArray(g,e.config.hideTargets))return d=!0})}}d&&b.addClass("jcsdl-option-hidden");d&&this.filter&&
this.filter.target!==i&&this.filter.fieldPath!==i&&this.filter.target+"."+this.filter.fieldPath.join(".").replace(/-/g,".")==c+"."+a&&(d=!1);d&&b.hide();return b},createInputSelectionView:function(a){var b=this,c=this.getTemplate("inputSelect"),d=c.find(".jcsdl-filter-target-field-input");f.each(a,function(a,c){b.createOptionForInput(c).appendTo(d)});return c},createOptionForInput:function(a){return this.getTemplate("inputSelectOption").data("name",a).addClass("icon-"+a+" input-"+a).html(a)},createValueInputView:function(a,
b){var b=b||a.input,c=this.getTemplate("valueInput");if(this.inputs[b]===i)return c;var d=this.inputs.exec(b,"init",[a]);d.find("input:first");var d=c.find(".jcsdl-filter-value-input-field").data("inputType",b).html(d),e=c.find(".jcsdl-filter-value-input-operators");"text"==b?this.createTextOperatorsSelectView(e,a,b,d):this.createOperatorsSelectView(e,a,b,d);return c},createOperatorsSelectView:function(a,b,c,d){var e=this,h=d.find("input:first"),g=this.definition.inputs[c]!==i?this.definition.inputs[c]:
{},j=g.operators!==i?g.operators:[];f.each(b.operators,function(b,c){if(0<j.length&&-1==f.inArray(c,j))return!0;var d=e.createOperatorOptionView(c);f.browser.msie&&d.html("&nbsp;");a.append(d)});a.children().bind("click touchstart",function(b){b.preventDefault();b.target.blur();var i=f(this),b=i.data("name");a.children().removeClass("selected");i.addClass("selected");"exists"==b?d.fadeOut(e.config.animate):d.is(":visible")||d.fadeIn(e.config.animate);"number"==c&&(i=0<=f.inArray(b,g.arrayOperators)?
"enable":"disable",h.jcsdlTagInput(i));e.trigger("operatorSelect",[b])});1==a.children().length?(a.children().eq(0).click(),a.children().hide()):(b=a.find(".operator-"+(b.operator!==i?b.operator:g.operator)),0<b.length?b.click():a.find(".operator:not(.operator-exists):first").click());return a},createTextOperatorsSelectView:function(a,b,c,d){var e=this;f(".jcsdl-dropdown").remove();a.addClass("text");var h=d.find("input.orig"),g=this.getTemplate("textOperatorsSelect"),j=this.getTemplate("textOperatorsDropdown"),
k=this.definition.inputs[c]!==i?this.definition.inputs[c]:{},m=k.operators!==i?k.operators:[];f.each(b.operators,function(a,b){if(0<m.length&&-1==f.inArray(b,m))return!0;var c=e.createTextOperatorOptionView(b);j.append(c)});a.html(g).insertAfter(d);j.hide().appendTo("body");if(b.cs){var l=this.getTemplate("caseSensitivity");l.bind("click touchstart",function(a){a.preventDefault();a.target.blur();f(this).toggleClass("selected");e.trigger("caseSensitivityChange",[f(this).is(".selected")])}).tipsy({gravity:"s",
offset:9});l.prependTo(a);g.addClass("has-cs")}g.click(function(a){a.preventDefault();a.target.blur();a.stopPropagation();g.hasClass("active")?(j.slideUp(e.config.animate),g.removeClass("active")):(j.css({top:g.offset().top+g.outerHeight()-1,left:g.offset().left,width:g.outerWidth()-2}).slideDown(e.config.animate),g.addClass("active"),f("body").bind("click.jcsdldropdown",function(a){a=f(a.target).closest(".jcsdl-dropdown");if(null==a||!a.is(".jcsdl-dropdown"))g.removeClass("active"),j.slideUp(e.config.animate),
f("body").unbind("click.jcsdldropdown")}))});j.find(".jcsdl-dropdown-details-trigger, .jcsdl-operator-help").click(function(a){a.preventDefault();a.target.blur();a.stopPropagation();var a=f(this).closest(".jcsdl-dropdown-option"),b=a.data("name"),c=f.jcsdlPopup({title:a.data("title")});e.jsonpCache.operators[b]===i?f.ajax({url:a.data("jsonp"),type:"GET",async:!1,jsonpCallback:"jcsdlJSONP",contentType:"application/json",dataType:"jsonp",success:function(a){!a||!a.html||!f.trim(a.html)?(c.setContent("<p>No documentation available.</p>"),
c.reposition()):(c.setContent(a.html),c.reposition(),e.jsonpCache.operators[b]=a.html)}}):(c.setContent(e.jsonpCache.operators[b]),c.reposition())});j.find(".jcsdl-dropdown-option").click(function(a){a.preventDefault();a.target.blur();g.removeClass("active");j.hide();var a=f(this).data("name"),c=e.definition.operators[a];g.data("operator",a).find(".jcsdl-operator-label").html(c.label);"exists"==a?(d.fadeOut(e.config.animate),b.cs&&l.fadeOut(e.config.animate)):d.is(":visible")||(d.fadeIn(e.config.animate),
b.cs&&l.fadeIn(e.config.animate));"contains_near"==a?(d.find(".jcsdl-containsnear-distance").fadeIn(),d.find(".jcsdl-tag-field input").bind("keydown.nospace",function(a){32==a.which&&a.preventDefault()}),h.jcsdlTagInput("update",!0),h.data("split",!0)):(d.find(".jcsdl-containsnear-distance").hide(),d.find(".jcsdl-tag-field input").unbind("keydown.nospace"),h.data("split")&&(h.jcsdlTagInput("update"),h.data("split",!1)));c=0<=f.inArray(a,k.arrayOperators)?"enable":"disable";h.jcsdlTagInput(c);"enable"==
c&&h.jcsdlTagInput("update");c=0<=f.inArray(a,["regex_partial","regex_exact"])?"enable":"disable";h.jcsdlRegExTester(c);"enable"==c&&(h.jcsdlRegExTester("set"+("regex_partial"==a?"Partial":"Exact")),h.jcsdlRegExTester("test"));e.trigger("operatorSelect",[a])});f(window).resize(function(){g.hasClass("active")&&j.css({top:g.offset().top+g.outerHeight()-1,left:g.offset().left,width:g.outerWidth()-2})});1==j.find(".jcsdl-dropdown-option").length?j.find(".jcsdl-dropdown-option:first").click():(c=j.find(".jcsdl-dropdown-option.operator-"+
(b.operator!==i?b.operator:k.operator)),0<c.length?c.click():j.find(".jcsdl-dropdown-option:not(.operator-exists):first").click());return a},createOperatorOptionView:function(a){var b=this.definition.operators[a];return b===i?f():this.getTemplate("operatorOption").data("name",a).addClass("icon-"+a+" operator-"+a).attr("title",b.description).html(b.label).tipsy({gravity:"s",offset:9})},createTextOperatorOptionView:function(a){var b=this.definition.operators[a];if(b===i)return f();var c=this.getTemplate("textOperatorOption").data("name",
a).data("title",b.label).addClass("operator-"+a);c.find(".jcsdl-icon").addClass("icon-"+a+" operator-"+a+" selected");c.find(".jcsdl-operator-label span").html(b.label);c.find(".jcsdl-operator-desc").html(b.description);b.jsonp?c.data("jsonp",b.jsonp):(c.find(".jcsdl-dropdown-details-trigger").remove(),c.find(".jcsdl-operator-help").remove());return c},setValueForField:function(a,b,c,d){var e=this,h=a.data("inputType");if(this.inputs[h]===i)return!1;if(0<=f.inArray(h,["geo_box","geo_radius","geo_polygon"])){var g=
jcsdlMapsCurrentGui,j=jcsdlMapsCurrentCallback,k=jcsdlMapsCurrentCallbackArgs;jcsdlMapsCurrentCallback=function(){g&&j&&setTimeout(function(){j.apply(g.inputs,k);e.inputs.exec(h,"setValue",[a,b,c,d])},g.config.animate+10)}}else this.inputs.exec(h,"setValue",[a,b,c,d]);return!0},getValueFromField:function(a,b,c){var d=a.data("inputType");return this.inputs[d]===i?"":this.inputs.exec(d,"getValue",[a,b,c])},getView:function(){return this.$view},getFilterInfo:function(){var a=this.getFieldInfoAtCurrentPath(),
b="text"==a.input?this.$view.find(".jcsdl-filter-value-input-operators .jcsdl-operators-select").data("operator"):this.$view.find(".jcsdl-filter-value-input-operators .operator.selected").data("name");if(b===i)this.showError("You need to select an operator!");else{var c="";if("exists"!==b&&(c=this.$view.find(".jcsdl-filter-value-input-field"),c=this.getValueFromField(c,a,b),0==c.length)){this.showError("You need to specify a value!");return}return{target:this.target,path:this.path,operator:b,value:c,
...
this.$guiContainer=this.initGui(this.$editor.find(".jcsdl-advanced-gui-container"));this.$gui=this.$guiContainer.find(".jcsdl-advanced-gui");this.$manual=this.$editor.find(".jcsdl-advanced-manual");this.$manualInput=this.initManualInput(this.$manual.find("input"));this.$logicOptions.click(function(a){a.preventDefault();a.target.blur();a=e(this);if(a.is(".disabled")||a.is(".active"))return!1;c.$logicOptions.removeClass("active");a.addClass("active");c.logic=a.data("logic");c.trigger("logicChange",
[c.logic]);c.logic==c.ADVANCED?(c.showEditor(),c.$logicOptions.not(".jcsdl-advanced").each(function(){var a=e(this);a.html(a.data("textShort"))}),c.$advancedOptions.fadeIn(c.config.animate)):(c.clearErrors(),c.hideEditor(),c.$logicOptions.not(".jcsdl-advanced").each(function(){var a=e(this);a.html(a.data("textLong"))}),c.$advancedOptions.hide())});this.$logicOptions.filter(".jcsdl-advanced").find(".jcsdl-logic-help").tipsy({gravity:"s",trigger:"manual",title:function(){return c.$editor.is(":visible")?
e(this).data(c.$manual.is(":visible")?"textManual":"textGui"):e(this).data("textGeneral")}}).click(function(a){a.preventDefault();a.target.blur();a.stopPropagation();var b=e(this);b.tipsy("show");e("body").one("click",function(){b.tipsy("hide")})});this.$advancedOptions.filter(".jcsdl-advanced-manual-edit").click(function(a){a.preventDefault();a.target.blur();a=e(this);if(a.is(".on")){try{c.validate(c.getManualString())}catch(b){c.showError(b);return}a.removeClass("on");a.html(a.data("textGui"));
c.$manualInput.blur();c.$manual.hide();c.$guiContainer.fadeIn(c.config.animate);c.$insertBracketsButton.removeClass("disabled");c.setGuiString()}else{try{c.validate(c.getGuiString())}catch(d){c.showError(d);return}a.addClass("on");a.html(a.data("textManual"));c.setManualString();c.$guiContainer.hide();c.$manual.fadeIn(c.config.animate);c.$manualInput.focus();c.$insertBracketsButton.addClass("disabled")}});try{this.setLogic(b)}catch(d){this.showError(d,!0)}};this.GUILogic.prototype={ADVANCED:"ADVANCED",
AND:"AND",OR:"OR",tokenize:function(a){a=a||this.logicString;return this.parser.tokenizeLogicString(a)},validate:function(a,b){a=a||this.logicString;b=b||this.gui.filters;return this.parser.validateLogic(a,b)},showEditor:function(){this.$editor.show();this.adjustGui();this.$editor.hide().slideDown(this.config.animate)},hideEditor:function(){this.$editor.slideUp(this.config.animate)},toggleButtons:function(a){(a=a===h?!0:a)||this.setLogic(this.AND);this.$logicOptions[a?"removeClass":"addClass"]("disabled")},
showError:function(a,b){b=b||!1;this.clearErrors();var c=a instanceof JCSDL.LogicValidationException?a.message:a,d=this.getTemplate("error");d.find("span").html(c);d.insertAfter(this.$editor);d.show();!b&&console!==h&&console.error(a,arguments);a instanceof JCSDL.LogicValidationException&&this.$gui.is(":visible")&&0<=a.index&&(c=this.$gui.children().not(".jcsdl-token-ph").eq(a.index).find(".jcsdl-logic-token").addClass("error"),this.scrollGuiToToken(c));d.animateIntoView(this.config.animate)},trigger:function(a,
b){this.gui.trigger(a,b)},clearErrors:function(){this.gui.clearErrors();this.$gui.find(".error").removeClass("error")},initGui:function(a){var b=this,c=a.find(".jcsdl-advanced-gui"),d=null;this.$guiLeft=a.find(".jcsdl-advanced-gui-arrow.left");this.$guiRight=a.find(".jcsdl-advanced-gui-arrow.right");c.sortable({cursor:"move",placeholder:"jcsdl-token-ph",containment:a,appendTo:a,helper:"clone",tolerance:"intersect",start:function(a,b){b.item.find(".jcsdl-logic-token").is(".bracket")&&c.find(".jcsdl-token-ph").addClass("bracket")},
stop:function(a,c){var d=c.item.find(".jcsdl-logic-token");d.is(".filter")&&b.gui.highlightFilter(d.data("token"),!1)},sort:function(a,c){clearInterval(d);b.$guiRight.is(":visible")&&c.offset.left+c.helper.width()/2>=b.$guiRight.offset().left&&(d=setInterval(function(){b.scrollGui("right",50)},50));b.$guiLeft.is(":visible")&&c.offset.left<=b.$guiLeft.offset().left+c.helper.width()/2&&(d=setInterval(function(){b.scrollGui("left",50)},50));var e=c.helper.find(".jcsdl-logic-token");e.is(".filter")&&
b.gui.highlightFilter(e.html())},update:function(){clearInterval(d);setTimeout(function(){b.updateFromGui()},100)}});c.data("sortable").floating=!0;c.data("uiSortable").floating=!0;this.$insertBracketsButton.click(function(a){a.preventDefault();a.target.blur();if(e(this).is(".disabled"))return!1;b.addGuiToken(")",!0,!0);b.updateFromGui()});this.$guiRight.add(this.$guiLeft).bind("mousedown touchstart",function(){var a=e(this).is(".right")?"right":"left";d=setInterval(function(){b.scrollGui(a,50)},
50)}).bind("mouseup mouseleave touchend",function(){clearInterval(d)}).click(function(a){a.preventDefault();a.target.blur()});e(window).resize(function(){b.adjustGui()});return a},updateFromGui:function(){var a=this.getGuiTokens();try{this.validate(a)&&(this.clearErrors(),this.logicString=a.join(""))}catch(b){this.showError(b,!0)}},setGuiString:function(a){var a=a||this.logicString,b=this,a="string"===typeof a||"number"===typeof a?this.tokenize(a):a;this.clearGui();e.each(a,function(a,d){b.addGuiToken(d,
!1)})},getGuiString:function(a){var a=a||this.$gui,b="";a.find(".jcsdl-logic-token").each(function(){b+=""+e(this).data("token")});return b},getGuiTokens:function(a){var a=a||this.$gui,b=[];a.find(".jcsdl-logic-token").each(function(){b.push(e(this).data("token"))});return b},clearGui:function(){this.$gui.width(0).children().remove()},tokensMap:{"(":"bracketOpen",")":"bracketClose","&":"operatorAnd","|":"operatorOr",filter:"filter"},addGuiToken:function(a,b,c){var b=b===h?!0:b,c=c===h?!1:c,d=this,
f="number"==typeof a?"filter":a;if(this.tokensMap[f]===h)throw'Invalid character "'+a+'" in the logic!';var g=this.getTemplate("logicToken_"+this.tokensMap[f]).data("token",a),i=e();"filter"==f&&g.html(a);f=e('<li class="jcsdl-logic-token-wrap" />').html(g).appendTo(this.$gui);this.$gui.width(this.$gui.width()+f.outerWidth(!0));if(")"==a&&c){var i=this.getTemplate("logicToken_bracketOpen").data("token","("),a=this.getGuiTokens().reverse(),j=a.length,k=-1,l=null;e.each(a,function(a,b){")"==b?k++:"("==
b&&k--;if(0==k&&0<=e.inArray(b,["&","|"])){if(null!==l&&b!==l)return j=a,!1;l=b}});a=this.$gui.children().eq(a.length-j);a=e('<li class="jcsdl-logic-token-wrap" />').html(i).insertBefore(a);this.$gui.width(this.$gui.width()+a.outerWidth(!0))}this.updateFromGui();this.adjustGui();b&&this.scrollGuiToToken(g);g.click(function(a){a.preventDefault();a.target.blur();"&"==g.data("token")?g.data("token","|").html("OR"):"|"==g.data("token")&&g.data("token","&").html("AND");d.updateFromGui()});g.add(i).find(".jcsdl-delete-token").click(function(a){a.preventDefault();
a.target.blur();a.stopPropagation(!0);d.deleteGuiToken(g)});g.filter(".filter").hover(function(){d.gui.highlightFilter(e(this).data("token"))},function(){d.gui.highlightFilter(e(this).data("token"),!1)})},deleteGuiFilterToken:function(a){var a=parseInt(a),b=e(),c=e();this.$gui.children().each(function(){var c=e(this);if(parseInt(c.find(".jcsdl-logic-token").data("token"))===a)return b=c,!1});if(!b.length)return!1;for(;"("==b.prev().find(".jcsdl-logic-token").data("token")&&")"==b.next().find(".jcsdl-logic-token").data("token");)b.prev().remove(),
b.next().remove();b.prev().find(".jcsdl-logic-token.operator").length?c=b.prev():b.next().find(".jcsdl-logic-token.operator").length&&(c=b.next());b.remove();c.remove();this.updateFromGui()},deleteGuiToken:function(a){var b=a.is(".jcsdl-logic-token")?a.closest("li.jcsdl-logic-token-wrap"):a;if(!b.is("li.jcsdl-logic-token-wrap"))return!1;a=b.find(".jcsdl-logic-token");if(a.is(".operator"))return!1;if(a.is(".filter")){var c=a.data("token"),d=!1;e.each(this.gui.filters,function(a,b){if(parseInt(b.id)==
parseInt(c))return d=!0,!1});if(d)return!1}else if(a.is(".bracket")){var f=this.getGuiTokens(),g=this.$gui.children().index(b),i=null,j=0,k=0,l=")",h="(",m=")";")"==a.data("token")&&(f=f.reverse(),g=f.length-1-g,l="(",h=")",m="(");e.each(f,function(a,b){if(a==g)return k=j,!0;if(null!==k&&j==k&&a>g&&b==l)return i="("==l?f.length-1-a:a,!1;b==h?j++:b==m&&j--});null!==i&&(a=this.$gui.children().filter(".jcsdl-logic-token-wrap").eq(i),this.$gui.width(this.$gui.width()-a.outerWidth(!0)),a.remove())}this.$gui.width(this.$gui.width()-
b.outerWidth(!0));b.remove();this.updateFromGui();this.adjustGui()},_adjustGuiTimeout:null,adjustGui:function(){var a=this,b=0;this.$gui.children().each(function(){b+=parseInt(e(this).outerWidth(!0))});this.$gui.width(b);clearTimeout(this._adjustGuiTimeout);this._adjustGuiTimeout=setTimeout(function(){var b=a.$gui.width(),d=a.$guiContainer.width();b>d?a.$guiRight.removeClass("off"):(a.$guiLeft.add(a.$guiRight).addClass("off"),a.scrollGuiToStart())},50)},scrollGui:function(a,b){var b=b==h?50:b,c=-1*
...
a.closest("li.jcsdl-logic-token-wrap"):a;if(!a.is("li.jcsdl-logic-token-wrap"))return!1;a=-1*a.position().left;parseInt(this.$gui.css("left"));this.scrollGui(a+140)},initManualInput:function(a){var b=this,c=null;a.keyup(function(){clearTimeout(c);c=setTimeout(function(){var c=a.val();try{b.validate(c)&&(b.clearErrors(),b.logicString=c)}catch(f){b.showError(f,!0)}},500)});a.keydown(function(a){var b=a.which,c=a.shiftKey;8==b||(37<=b&&40>=b||46==b||48<=b&&57>=b&&!c||96<=b&&105>=b||219==b||57==b&&c||
221==b||48==b&&c||32==b||55==b&&c||220==b&&c)||a.preventDefault()});a.keypress(function(a){13==a.which&&a.preventDefault()});return a},setManualString:function(a){a=a||this.logicString;a="string"===typeof a||"number"===typeof a?this.tokenize(a):a;this.$manualInput.val(a.join(" "))},getManualString:function(){return this.$manualInput.val()},setLogic:function(a){this.logic=-1<e.inArray(a,[this.AND,this.OR])?a:this.ADVANCED;this.$logicOptions.filter('[data-logic="'+this.logic+'"]').click();var b="";
if(this.logic==this.ADVANCED)b=a;else{var c=[];e.each(this.gui.filters,function(a,b){c.push(b.id)});b=c.join(this.logic==this.OR?"|":"&")}this.setLogicString(b)},getLogic:function(){return this.logic},setLogicString:function(a){this.logicString=""+a;this.setGuiString(a);this.setManualString(a)},appendFilterToLogicString:function(a,b){b=b||this.logic;b=b==this.OR?"|":"&";this.setLogicString(this.logicString.length?this.logicString+b+a:a)},getLogicString:function(){return this.logic==this.ADVANCED?
this.logicString:this.logic}}});;
;JCSDL.Loader.addComponent(function(e,f){this.GUI=function(a,b){var c=e(a);if(0==c.length)return!1;this.$el=c.eq(0);this.$container=null;this.config=e.extend(!0,{animate:200,cancelButton:!0,saveButton:null,googleMapsApiKey:"",mapsOverlay:{strokeWeight:0,fillColor:"#7585dd",fillOpacity:0.5},mapsMarker:"jcsdl/img/maps-marker.png",hideTargets:[],definition:{},save:function(){},saveError:function(){},cancel:function(){this.hide()},invalidJCSDL:function(){},logicChange:function(){},viewModeChange:function(){},
filterNew:function(){},filterEdit:function(){},filterDelete:function(){},filterSave:function(){},filterCancel:function(){},targetSelect:function(){},operatorSelect:function(){},caseSensitivityChange:function(){},targetHelpUrl:function(a,b){if(b.helpUrl)return b.helpUrl;a=a.replace(/\./g,"-");return this.definition.targetHelpJsonpSource.replace(/\{target\}/g,a)}},b);this.definition=e.extend(!0,JCSDLDefinition,this.config.definition);this.parser=new JCSDL.Parser(this);this.logic=null;this.inputs=new JCSDL.GUIInputs(this);
this.filters=[];this.$filtersList=this.$mainView=this.currentFilterIndex=null;this.init()};this.GUI.prototype={init:function(){var a=this;this.filters=[];this.currentFilterIndex=null;this.$mainView=this.getTemplate("editor");this.$filtersList=this.$mainView.find(".jcsdl-filters-list");this.$container=this.getTemplate("container");this.$container.html(this.$mainView);this.$el.html(this.$container);this.$saveButton=this.$mainView.find(".jcsdl-editor-save");this.$cancelButton=this.$mainView.find(".jcsdl-editor-cancel");
if(this.config.saveButton&&("object"==typeof this.config.saveButton||"string"==typeof this.config.saveButton))this.$saveButton.remove(),this.$saveButton=e(this.config.saveButton);if(this.config.cancelButton&&("object"==typeof this.config.cancelButton||"string"==typeof this.config.cancelButton))this.$cancelButton.remove(),this.$cancelButton=e(this.config.cancelButton);this.config.cancelButton||this.$cancelButton.hide();e.browser.msie&&this.$container.addClass("msie");this.logic=new JCSDL.GUILogic(this,
JCSDL.GUILogic.prototype.AND);this.$mainView.find(".jcsdl-mainview-mode .jcsdl-mainview-mode-option").bind("click touchstart",function(b){b.preventDefault();b.target.blur();var b=e(this),c=b.attr("data-mode");a.$filtersList.removeClass("expanded collapsed");a.$filtersList.addClass(c);a.$mainView.find(".jcsdl-mainview-mode .jcsdl-mainview-mode-option").removeClass("active");b.addClass("active");a.trigger("viewModeChange",[c])});this.$mainView.find(".jcsdl-add-filter").bind("click touchstart",function(b){b.preventDefault();
b.target.blur();a.showFilterEditor()});this.$saveButton.unbind(".jcsdl").bind("click.jcsdl touchstart.jcsdl",function(b){b.preventDefault();b.target.blur();try{var c=a.returnJCSDL();a.trigger("save",[c])}catch(d){a.showError(d),a.trigger("saveError",[d instanceof JCSDL.LogicValidationException?d.message:d])}});this.$cancelButton.unbind(".jcsdl").bind("click.jcsdl touchstart.jcsdl",function(b){b.preventDefault();b.target.blur();a.trigger("cancel")})},reset:function(){this.init()},loadJCSDL:function(a){this.init();
var b=this;try{var c=this.parser.parseJCSDL(a);this.filters=c.filters;2<=this.filters.length&&this.logic.toggleButtons();this.logic.setLogic(c.logic)}catch(d){return a=d instanceof JCSDL.ValidationException?d.code:a,this.showError(d,a),this.trigger("invalidJCSDL",[a]),!1}e.each(this.filters,function(a,c){b.createFilterRow(c).appendTo(b.$filtersList)});this.filters.length&&this.$mainView.find(".jcsdl-footer").show();this.config.cancelButton&&this.$cancelButton.show()},returnJCSDL:function(){return this.parser.getJCSDLForFilters(this.filters,
this.logic.getLogicString())},adjust:function(){this.editor&&this.editor.adjust()},hide:function(){this.$container.hide()},show:function(){this.$container.show()},trigger:function(a,b){b=b||[];this.$el.trigger(a.toLowerCase(),b);return"function"==typeof this.config[a]?this.config[a].apply(this,b):null},showFilterEditor:function(a,b){this.$mainView.hide();this.editor=new JCSDL.GUIFilterEditor(this,this.$container,a);if(a!==f&&a)this.currentFilterIndex=b,this.trigger("filterEdit",[a]);else{this.trigger("filterNew");
var c=this.filters[this.filters.length-1];c!==f&&this.editor.getView().find(".jcsdl-filter-target .target-"+c.target+":visible").trigger("jcsdlclick")}},hideFilterEditor:function(a){var a="function"==typeof a?a:e.noop,b=this;this.currentFilterIndex=null;this.editor.getView().fadeOut(this.config.animate,function(){e(this).remove();b.$mainView.show();b.editor=null;a.apply(b,[])})},didSubmitFilter:function(a){var b=this,c=e.noop,d=null!==this.currentFilterIndex?this.filters[this.currentFilterIndex].id:
...
this.definition.operators[a.operator].description).html(this.definition.operators[a.operator].code.escapeHtml()).tipsy({gravity:"s",offset:9});c.find(".operator").html(f);if(a.cs){var h=this.getTemplate("filterOperator").addClass("operator-cs icon-cs selected").attr("title","Case Sensitive").html("case sensitive").tipsy({gravity:"s",offset:9});c.find(".jcsdl-filter-info.operator").append(h);h.tipsy("show")}if("exists"!==a.operator){var i=null,h=(i=0<=e.inArray(a.operator,["geo_box","geo_polygon",
"geo_radius"]))?a.operator:d.input;i&&(this.getTemplate("filterFieldInput").insertAfter(c.find(".jcsdl-filter-info.field")).find(".jcsdl-filter-field-input").addClass("selected icon-"+a.operator),f.remove());i=this.inputs[h]&&"function"==typeof this.inputs[h].displayValue?this.inputs.exec(h,"displayValue",[d,a.value,a]):this.getTemplate("filterValue").html(a.value.truncate(50).escapeHtml());c.find(".value").addClass("input-"+h).html(i);c.find(".operator").addClass("input-"+h)}else c.find(".value").remove();
