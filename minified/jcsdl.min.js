...
b){this.gui.trigger(a,b)},clearErrors:function(){this.gui.clearErrors();this.$gui.find(".error").removeClass("error")},initGui:function(a){var b=this,c=a.find(".jcsdl-advanced-gui"),d=null;this.$guiLeft=a.find(".jcsdl-advanced-gui-arrow.left");this.$guiRight=a.find(".jcsdl-advanced-gui-arrow.right");c.sortable({cursor:"move",placeholder:"jcsdl-token-ph",containment:this.$editor,appendTo:this.$editor,helper:"clone",tolerance:"intersect",start:function(a,b){b.item.find(".jcsdl-logic-token").is(".bracket")&&
c.find(".jcsdl-token-ph").addClass("bracket")},stop:function(a,c){var d=c.item.find(".jcsdl-logic-token");d.is(".filter")&&b.gui.highlightFilter(d.data("token"),!1)},sort:function(a,c){clearInterval(d);b.$guiRight.is(":visible")&&c.offset.left+c.helper.width()/2>=b.$guiRight.offset().left&&(d=setInterval(function(){b.scrollGui("right",50)},50));b.$guiLeft.is(":visible")&&c.offset.left<=b.$guiLeft.offset().left+c.helper.width()/2&&(d=setInterval(function(){b.scrollGui("left",50)},50));var e=c.helper.find(".jcsdl-logic-token");
e.is(".filter")&&b.gui.highlightFilter(e.html())},update:function(){clearInterval(d);setTimeout(function(){b.updateFromGui()},100)}});c.data("sortable").floating=!0;c.data("uiSortable").floating=!0;this.$insertBracketsButton.click(function(a){a.preventDefault();a.target.blur();if(e(this).is(".disabled"))return!1;b.addGuiToken(")",!0,!0);b.updateFromGui()});this.$guiRight.add(this.$guiLeft).bind("mousedown touchstart",function(){var a=e(this).is(".right")?"right":"left";d=setInterval(function(){b.scrollGui(a,
50)},50)}).bind("mouseup mouseleave touchend",function(){clearInterval(d)}).click(function(a){a.preventDefault();a.target.blur()});e(window).resize(function(){b.adjustGui()});return a},updateFromGui:function(){var a=this.getGuiTokens();try{this.validate(a)&&(this.clearErrors(),this.logicString=a.join(""))}catch(b){this.showError(b,!0)}},setGuiString:function(a){var a=a||this.logicString,b=this,a="string"===typeof a||"number"===typeof a?this.tokenize(a):a;this.clearGui();e.each(a,function(a,d){b.addGuiToken(d,
