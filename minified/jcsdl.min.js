...
(function(){var e=Crypto,j=e.util,b=e.charenc,a=b.UTF8,c=b.Binary,d=e.MD5=function(a,b){var e=j.wordsToBytes(d._md5(a));return b&&b.asBytes?e:b&&b.asString?c.bytesToString(e):j.bytesToHex(e)};d._md5=function(b){b.constructor==String&&(b=a.stringToBytes(b));var c=j.bytesToWords(b),e=8*b.length;b=1732584193;for(var g=-271733879,m=-1732584194,k=271733878,q=0;q<c.length;q++)c[q]=(c[q]<<8|c[q]>>>24)&16711935|(c[q]<<24|c[q]>>>8)&4278255360;c[e>>>5]|=128<<e%32;c[(e+64>>>9<<4)+14]=e;for(var e=d._ff,n=d._gg,
p=d._hh,t=d._ii,q=0;q<c.length;q+=16){var r=b,u=g,z=m,v=k;b=e(b,g,m,k,c[q+0],7,-680876936);k=e(k,b,g,m,c[q+1],12,-389564586);m=e(m,k,b,g,c[q+2],17,606105819);g=e(g,m,k,b,c[q+3],22,-1044525330);b=e(b,g,m,k,c[q+4],7,-176418897);k=e(k,b,g,m,c[q+5],12,1200080426);m=e(m,k,b,g,c[q+6],17,-1473231341);g=e(g,m,k,b,c[q+7],22,-45705983);b=e(b,g,m,k,c[q+8],7,1770035416);k=e(k,b,g,m,c[q+9],12,-1958414417);m=e(m,k,b,g,c[q+10],17,-42063);g=e(g,m,k,b,c[q+11],22,-1990404162);b=e(b,g,m,k,c[q+12],7,1804603682);k=e(k,
b,g,m,c[q+13],12,-40341101);m=e(m,k,b,g,c[q+14],17,-1502002290);g=e(g,m,k,b,c[q+15],22,1236535329);b=n(b,g,m,k,c[q+1],5,-165796510);k=n(k,b,g,m,c[q+6],9,-1069501632);m=n(m,k,b,g,c[q+11],14,643717713);g=n(g,m,k,b,c[q+0],20,-373897302);b=n(b,g,m,k,c[q+5],5,-701558691);k=n(k,b,g,m,c[q+10],9,38016083);m=n(m,k,b,g,c[q+15],14,-660478335);g=n(g,m,k,b,c[q+4],20,-405537848);b=n(b,g,m,k,c[q+9],5,568446438);k=n(k,b,g,m,c[q+14],9,-1019803690);m=n(m,k,b,g,c[q+3],14,-187363961);g=n(g,m,k,b,c[q+8],20,1163531501);
b=n(b,g,m,k,c[q+13],5,-1444681467);k=n(k,b,g,m,c[q+2],9,-51403784);m=n(m,k,b,g,c[q+7],14,1735328473);g=n(g,m,k,b,c[q+12],20,-1926607734);b=p(b,g,m,k,c[q+5],4,-378558);k=p(k,b,g,m,c[q+8],11,-2022574463);m=p(m,k,b,g,c[q+11],16,1839030562);g=p(g,m,k,b,c[q+14],23,-35309556);b=p(b,g,m,k,c[q+1],4,-1530992060);k=p(k,b,g,m,c[q+4],11,1272893353);m=p(m,k,b,g,c[q+7],16,-155497632);g=p(g,m,k,b,c[q+10],23,-1094730640);b=p(b,g,m,k,c[q+13],4,681279174);k=p(k,b,g,m,c[q+0],11,-358537222);m=p(m,k,b,g,c[q+3],16,-722521979);
g=p(g,m,k,b,c[q+6],23,76029189);b=p(b,g,m,k,c[q+9],4,-640364487);k=p(k,b,g,m,c[q+12],11,-421815835);m=p(m,k,b,g,c[q+15],16,530742520);g=p(g,m,k,b,c[q+2],23,-995338651);b=t(b,g,m,k,c[q+0],6,-198630844);k=t(k,b,g,m,c[q+7],10,1126891415);m=t(m,k,b,g,c[q+14],15,-1416354905);g=t(g,m,k,b,c[q+5],21,-57434055);b=t(b,g,m,k,c[q+12],6,1700485571);k=t(k,b,g,m,c[q+3],10,-1894986606);m=t(m,k,b,g,c[q+10],15,-1051523);g=t(g,m,k,b,c[q+1],21,-2054922799);b=t(b,g,m,k,c[q+8],6,1873313359);k=t(k,b,g,m,c[q+15],10,-30611744);
m=t(m,k,b,g,c[q+6],15,-1560198380);g=t(g,m,k,b,c[q+13],21,1309151649);b=t(b,g,m,k,c[q+4],6,-145523070);k=t(k,b,g,m,c[q+11],10,-1120210379);m=t(m,k,b,g,c[q+2],15,718787259);g=t(g,m,k,b,c[q+9],21,-343485551);b=b+r>>>0;g=g+u>>>0;m=m+z>>>0;k=k+v>>>0}return j.endian([b,g,m,k])};d._ff=function(a,b,c,d,e,k,q){a=a+(b&c|~b&d)+(e>>>0)+q;return(a<<k|a>>>32-k)+b};d._gg=function(a,b,c,d,e,k,q){a=a+(b&d|c&~d)+(e>>>0)+q;return(a<<k|a>>>32-k)+b};d._hh=function(a,b,c,d,e,k,q){a=a+(b^c^d)+(e>>>0)+q;return(a<<k|a>>>
32-k)+b};d._ii=function(a,b,c,d,e,k,q){a=a+(c^(b|~d))+(e>>>0)+q;return(a<<k|a>>>32-k)+b};d._blocksize=16;d._digestsize=16})();JCSDL.Loader.addComponent(function(){var e=jQuery,j=window,b=document,a=e("body");e("html").add(a);e(j);e.extend(e,{string:{trim:function(a,b){var f,e=0,l=0;f=b?(b+"").replace(/([\[\]\(\)\.\?\/\*\{\}\+\$\^\:])/g,"$1"):" \n\r\t\f\x0B\u00a0\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u200b\u2028\u2029\u3000";e=a.length;for(l=0;l<e;l++)if(-1===f.indexOf(a.charAt(l))){a=a.substring(l);break}e=a.length;for(l=e-1;0<=l;l--)if(-1===f.indexOf(a.charAt(l))){a=a.substring(0,l+1);break}return-1===
f.indexOf(a.charAt(0))?a:""},truncate:function(a,b,f){b=b||72;f=f||"...";if(a.length<=b)return a;a=a.substr(0,b);return a.substr(0,a.lastIndexOf(" "))+f}}});e.fn.extend({quickEach:function(a){for(var b=e([0]),f=-1,h=this.length,l;++f<h&&(l=b[0]=this[f])&&!1!==a.call(b,f,l););return this},display:function(a){return this.css("display",a||"inline-block")},outerHtml:function(){var a=e(this);if("outerHTML"in a[0])return a[0].outerHTML;var b=a.wrap("<div></div>").parent().html();a.unwrap();return b},isAfter:function(a){return 0<
this.prevAll(a).length},isBefore:function(a){return 0<this.nextAll(a).length},scrollIntoView:function(a,d){var f=b.body,h=a&&e(a).get(0)||f,l=h===b.documentElement||h===b.body,g=l?e(j):e(h),m=e(this).get(0),k=e(m).getOffsetsTo(h);f!==h&&(k[0]-=g.css("borderLeftWidth").replace("px",""),k[1]-=g.css("borderTopWidth").replace("px",""));var q=g.scrollTop(),n=g.scrollLeft(),f=k[0]+(l?0:n),l=k[1]+(l?0:q),k=l+m.offsetHeight,h=f+m.offsetWidth,p=g.height(),t=g.width(),q=parseInt(q,10),n=parseInt(n,10),r=q+
p,u=n+t;m.offsetHeight>p||l<q?g.scrollTop(l):k>r&&g.scrollTop(k-p);!1!==d&&(m.offsetWidth>t||f<n?g.scrollLeft(f):h>u&&g.scrollLeft(h-t));return this},getOffsetsTo:function(a){a=e(a).get(0);var d=e(this).offset();a=b.documentElement===a||b.body===a?{top:0,left:0}:e(a).offset();return[d.left-a.left,d.top-a.top]}})});JCSDL.Loader.addComponent(function(){var e=jQuery,j=function(a,c){var d,f,h,g=a.nodeName.toLowerCase();return"area"===g?(d=a.parentNode,f=d.name,a.href&&f&&"map"===d.nodeName.toLowerCase()?(h=e("img[usemap=#"+f+"]")[0],!!h&&b(h)):!1):(/input|select|textarea|button|object/.test(g)?!a.disabled:"a"===g?a.href||c:c)&&b(a)},b=function(a){return e.expr.filters.visible(a)&&!e(a).parents().addBack().filter(function(){return"hidden"===e.css(this,"visibility")}).length},a=0,c=/^ui-id-\d+$/;e.ui=e.ui||{};e.extend(e.ui,
...
b&&"left"===b?"scrollLeft":"scrollTop";return 0<a[c]?!0:(a[c]=1,a[c]=0,!1)}});var f=jQuery,h=void 0,l=0,g=Array.prototype.slice,m=f.cleanData;f.cleanData=function(a){for(var b,c=0;null!=(b=a[c]);c++)try{f(b).triggerHandler("remove")}catch(d){}m(a)};f.widget=function(a,b,c){var d,e,g,k,m={},l=a.split(".")[0];a=a.split(".")[1];d=l+"-"+a;c||(c=b,b=f.Widget);f.expr[":"][d.toLowerCase()]=function(a){return!!f.data(a,d)};f[l]=f[l]||{};e=f[l][a];g=f[l][a]=function(a,b){return this._createWidget?(arguments.length&&
this._createWidget(a,b),h):new g(a,b)};f.extend(g,e,{version:c.version,_proto:f.extend({},c),_childConstructors:[]});k=new b;k.options=f.widget.extend({},k.options);f.each(c,function(a,c){var d;if(f.isFunction(c)){var u=function(){return b.prototype[a].apply(this,arguments)},e=function(c){return b.prototype[a].apply(this,c)};d=(m[a]=function(){var a,b=this._super,d=this._superApply;return this._super=u,this._superApply=e,a=c.apply(this,arguments),this._super=b,this._superApply=d,a},h)}else d=(m[a]=
c,h);return d});g.prototype=f.widget.extend(k,{widgetEventPrefix:e?k.widgetEventPrefix:a},m,{constructor:g,namespace:l,widgetName:a,widgetFullName:d});e?(f.each(e._childConstructors,function(a,b){var c=b.prototype;f.widget(c.namespace+"."+c.widgetName,g,b._proto)}),delete e._childConstructors):b._childConstructors.push(g);f.widget.bridge(a,g)};f.widget.extend=function(a){for(var b,c,d=g.call(arguments,1),e=0,k=d.length;k>e;e++)for(b in d[e])c=d[e][b],d[e].hasOwnProperty(b)&&c!==h&&(a[b]=f.isPlainObject(c)?
f.isPlainObject(a[b])?f.widget.extend({},a[b],c):f.widget.extend({},c):c);return a};f.widget.bridge=function(a,b){var c=b.prototype.widgetFullName||a;f.fn[a]=function(d){var e="string"==typeof d,k=g.call(arguments,1),m=this;return d=!e&&k.length?f.widget.extend.apply(null,[d].concat(k)):d,e?this.each(function(){var b,e=f.data(this,c);return e?f.isFunction(e[d])&&"_"!==d.charAt(0)?(b=e[d].apply(e,k),b!==e&&b!==h?(m=b&&b.jquery?m.pushStack(b.get()):b,!1):h):f.error("no such method '"+d+"' for "+a+" widget instance"):
f.error("cannot call methods on "+a+" prior to initialization; attempted to call method '"+d+"'")}):this.each(function(){var a=f.data(this,c);a?a.option(d||{})._init():f.data(this,c,new b(d,this))}),m}};f.Widget=function(){};f.Widget._childConstructors=[];f.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",defaultElement:"<div>",options:{disabled:!1,create:null},_createWidget:function(a,b){b=f(b||this.defaultElement||this)[0];this.element=f(b);this.uuid=l++;this.eventNamespace="."+this.widgetName+
...
(c=b,b=this.element,d=this.widget());f.each(c,function(c,v){function g(){return a||!0!==e.options.disabled&&!f(this).hasClass("ui-state-disabled")?("string"==typeof v?e[v]:v).apply(e,arguments):h}"string"!=typeof v&&(g.guid=v.guid=v.guid||g.guid||f.guid++);var k=c.match(/^(\w+)\s*(.*)$/),m=k[1]+e.eventNamespace;(k=k[2])?d.delegate(k,m,g):b.bind(m,g)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.unbind(b).undelegate(b)},_delay:function(a,b){var c=this;
...
String?b.snap.items||":data(ui-draggable)":b.snap).each(function(){var b=n(this),c=b.offset();this!==a.element[0]&&a.snapElements.push({item:this,width:b.outerWidth(),height:b.outerHeight(),top:c.top,left:c.left})})},drag:function(a,b){var c,d,f,e,h,g,k,m,l,q,j=n(this).data("ui-draggable"),p=j.options,r=p.snapTolerance,t=b.offset.left,x=t+j.helperProportions.width,w=b.offset.top,y=w+j.helperProportions.height;for(l=j.snapElements.length-1;0<=l;l--)h=j.snapElements[l].left,g=h+j.snapElements[l].width,
k=j.snapElements[l].top,m=k+j.snapElements[l].height,h-r>x||t>g+r||k-r>y||w>m+r||!n.contains(j.snapElements[l].item.ownerDocument,j.snapElements[l].item)?(j.snapElements[l].snapping&&j.options.snap.release&&j.options.snap.release.call(j.element,a,n.extend(j._uiHash(),{snapItem:j.snapElements[l].item})),j.snapElements[l].snapping=!1):("inner"!==p.snapMode&&(c=r>=Math.abs(k-y),d=r>=Math.abs(m-w),f=r>=Math.abs(h-x),e=r>=Math.abs(g-t),c&&(b.position.top=j._convertPositionTo("relative",{top:k-j.helperProportions.height,
left:0}).top-j.margins.top),d&&(b.position.top=j._convertPositionTo("relative",{top:m,left:0}).top-j.margins.top),f&&(b.position.left=j._convertPositionTo("relative",{top:0,left:h-j.helperProportions.width}).left-j.margins.left),e&&(b.position.left=j._convertPositionTo("relative",{top:0,left:g}).left-j.margins.left)),q=c||d||f||e,"outer"!==p.snapMode&&(c=r>=Math.abs(k-w),d=r>=Math.abs(m-y),f=r>=Math.abs(h-t),e=r>=Math.abs(g-x),c&&(b.position.top=j._convertPositionTo("relative",{top:k,left:0}).top-
j.margins.top),d&&(b.position.top=j._convertPositionTo("relative",{top:m-j.helperProportions.height,left:0}).top-j.margins.top),f&&(b.position.left=j._convertPositionTo("relative",{top:0,left:h}).left-j.margins.left),e&&(b.position.left=j._convertPositionTo("relative",{top:0,left:g-j.helperProportions.width}).left-j.margins.left)),!j.snapElements[l].snapping&&(c||d||f||e||q)&&j.options.snap.snap&&j.options.snap.snap.call(j.element,a,n.extend(j._uiHash(),{snapItem:j.snapElements[l].item})),j.snapElements[l].snapping=
...
a.placeholder=p(c.placeholder.element.call(a.element,a.currentItem));a.currentItem.after(a.placeholder);c.placeholder.update(a,a.placeholder)},_contactContainers:function(a){var b,c,d,f,e,h,g,k,m,l=c=null;for(b=this.containers.length-1;0<=b;b--)if(!p.contains(this.currentItem[0],this.containers[b].element[0]))if(this._intersectsWith(this.containers[b].containerCache)){if(!c||!p.contains(this.containers[b].element[0],c.element[0]))c=this.containers[b],l=b}else this.containers[b].containerCache.over&&
(this.containers[b]._trigger("out",a,this._uiHash(this)),this.containers[b].containerCache.over=0);if(c)if(1===this.containers.length)this.containers[l].containerCache.over||(this.containers[l]._trigger("over",a,this._uiHash(this)),this.containers[l].containerCache.over=1);else{b=1E4;d=null;f=(m=c.floating||t(this.currentItem))?"left":"top";e=m?"width":"height";h=this.positionAbs[f]+this.offset.click[f];for(c=this.items.length-1;0<=c;c--)p.contains(this.containers[l].element[0],this.items[c].item[0])&&
this.items[c].item[0]!==this.currentItem[0]&&(!m||this.positionAbs.top+this.offset.click.top>this.items[c].top&&this.items[c].top+this.items[c].height>this.positionAbs.top+this.offset.click.top)&&(g=this.items[c].item.offset()[f],k=!1,Math.abs(g-h)>Math.abs(g+this.items[c][e]-h)&&(k=!0,g+=this.items[c][e]),b>Math.abs(g-h)&&(b=Math.abs(g-h),d=this.items[c],this.direction=k?"up":"down"));if((d||this.options.dropOnEmpty)&&this.currentContainer!==this.containers[l])d?this._rearrange(a,d,null,!0):this._rearrange(a,
...
a.range:""))):this.range=r([])},_setupEvents:function(){var a=this.handles.add(this.range).filter("a");this._off(a);this._on(a,this._handleEvents);this._hoverable(a);this._focusable(a)},_destroy:function(){this.handles.remove();this.range.remove();this.element.removeClass("ui-slider ui-slider-horizontal ui-slider-vertical ui-widget ui-widget-content ui-corner-all");this._mouseDestroy()},_mouseCapture:function(a){var b,c,d,f,e,h,g,k,m=this,l=this.options;return l.disabled?!1:(this.elementSize={width:this.element.outerWidth(),
height:this.element.outerHeight()},this.elementOffset=this.element.offset(),b={x:a.pageX,y:a.pageY},c=this._normValueFromMouse(b),d=this._valueMax()-this._valueMin()+1,this.handles.each(function(a){var b=Math.abs(c-m.values(a));(d>b||d===b&&(a===m._lastChangedValue||m.values(a)===l.min))&&(d=b,f=r(this),e=a)}),h=this._start(a,e),!1===h?!1:(this._mouseSliding=!0,this._handleIndex=e,f.addClass("ui-state-active").focus(),g=f.offset(),k=!r(a.target).parents().addBack().is(".ui-slider-handle"),this._clickOffset=
...
var a=e.extend({},this.$element.offset(),{width:this.$element[0].offsetWidth,height:this.$element[0].offsetHeight}),d=b[0].offsetWidth,f=b[0].offsetHeight,h="function"==typeof this.options.gravity?this.options.gravity.call(this.$element[0]):this.options.gravity,l;switch(h.charAt(0)){case "n":l={top:a.top+a.height+this.options.offset,left:a.left+a.width/2-d/2};break;case "s":l={top:a.top-f-this.options.offset,left:a.left+a.width/2-d/2};break;case "e":l={top:a.top+a.height/2-f/2,left:a.left-d-this.options.offset};
break;case "w":l={top:a.top+a.height/2-f/2,left:a.left+a.width+this.options.offset}}2==h.length&&(l.left="w"==h.charAt(1)?a.left+a.width/2-15:a.left+a.width/2-d+15);b.css(l).addClass("tipsy-"+h);this.options.fade?b.stop().css({opacity:0,display:"block",visibility:"visible"}).animate({opacity:this.options.opacity}):b.css({visibility:"visible",opacity:this.options.opacity})}},hide:function(){this.options.fade?this.tip().stop().fadeOut(function(){e(this).remove()}):this.tip().remove()},getTitle:function(){var a,
...
a)return this.data("tipsy");if("string"==typeof a)return this.data("tipsy")[a]();a=e.extend({},e.fn.tipsy.defaults,a);a.live||this.each(function(){c(this)});if("manual"!=a.trigger){var h=a.live?"live":"bind",l="hover"==a.trigger?"mouseleave":"blur";this[h]("hover"==a.trigger?"mouseenter":"focus",d)[h](l,f)}return this};e.fn.tipsy.defaults={delayIn:0,delayOut:0,fade:!1,fallback:"",gravity:"n",html:!1,live:!1,offset:0,opacity:0.8,title:"title",trigger:"hover"};e.fn.tipsy.elementOptions=function(a,b){return e.metadata?
...
this.recoverActive&&this.domElement.addClass("active"));break;case "mouseout":this.domElement&&this.cssEffects&&(this.recoverActive=!1,this.domElement.hasClass("active")&&(this.domElement.removeClass("active"),this.recoverActive=!0),this.domElement.removeClass("hover"));break;case "mousedown":this.domElement&&this.cssEffects&&this.domElement.addClass("active");break;case "mouseup":this.domElement&&this.cssEffects&&(this.domElement.removeClass("active"),this.recoverActive=!1)}if(this.handlers[a])for(var l=
0,g=this.handlers[a].length;l<g;l++){var m=this.handlers[a][l];if("function"==typeof m)m(this,b);else if("object"==typeof m&&2==m.length)m[0][m[1]](this,b);else if("string"==typeof m)e[m](this,b)}}})})})(window);JCSDL.Loader.addComponent(function(e,j){this.Parser=function(b){this.gui=b};this.Parser.prototype={v:"2.1",parseJCSDL:function(b){var a=b.split("\n"),c=a.shift();a.pop();if(!this.verifyJCSDL(c,a))throw new JCSDL.ValidationException("The given JCSDL did not verify!",b);b=a.shift().split(" ")[2];var c=c.split(" ")[3],d=[];for("//"!==a[0].substr(0,2)&&a.shift();1<a.length;){var f=a.shift(),e=a.shift();a.shift();a.shift();var f=f.split(" "),l=f[3],g=f[4]||d.length+1;if(!this.verifyJCSDLFilter(f[2],e))throw new JCSDL.ValidationException("The given JCSDL Filter code did not verify!",
e);f=this.filterFromJCSDL(l,e,g,b);d.push(f)}return{filters:d,logic:c}},filterFromJCSDL:function(b,a,c,d){d=d||this.v;d!==this.v&&(b=this.applyFilterJCSDLTransformers(b,d));b=b.split(",");d=b.shift().split(".");var f=d.shift(),h=this.getFieldInfo(f,d);if(!1===h)return!1;var l=b.shift(),g="",m={cs:!1};"exists"!==l&&(g=b.shift().split("-"),g=this.valueFromCSDL(h,a.substr(g[0],g[1]),l),e.each(b,function(a,b){switch(b){case "cs":m.cs=!0}}));return this.createFilter(f,d,l,g,m,c)},getJCSDLForFilters:function(b,
a){var c=this,d={},f=[],h="";e.each(b,function(a,b){var f=c.filterToCSDL(b);if(!f)return!0;d[b.id+""]=f});if("AND"!=a&&"OR"!=a){var h=this.tokenizeLogicString(a),l="";this.validateLogic(h,b);e.each(h,function(a,b){if("number"===typeof b)if(l.length&&f.push(e.trim(l)),l="",d[b+""]!==j)f.push(d[b+""]);else throw new JCSDL.LogicValidationException("A filter with ID '"+b+"' doesn't exist! You cannot use it in a logical expression",a);else l="&"==b||"|"==b?l+("|"==b?" OR ":" AND "):"!"===b?l+" NOT ":l+
b});l.length&&f.push(e.trim(l));h=f.join("\n")}else e.each(d,function(a,b){f.push(b)}),h=f.join("\n"+a+"\n");h="// JCSDL_VERSION "+this.v+"\n"+h;return h="// JCSDL_MASTER "+this.encodeJCSDL(h,a)+" "+a+"\n"+h+"\n// JCSDL_MASTER_END"},filterToCSDL:function(b){var a=this.getFieldInfo(b.target,b.fieldPath);if(!1===a)return!1;var c=this.valueToCSDL(b.value,a,b.operator);if(!1===c)return!1;var d=this.fieldToCSDL(b.fieldPath);if(!1===d)return!1;var f=this.getOperatorCode(b.operator);if(!1===f)return!1;var e=
b.cs?" cs":"",f=("augmentation"==b.target?"":b.target+".")+d.replace("-",".")+e+" "+f+" ",d=b.target+"."+d+","+b.operator;"exists"!==b.operator&&(e="string"==a.type||"geo"==a.type?f.length+1:f.length,a="string"==a.type||"geo"==a.type?c.length-2:c.length,f+=c,d+=","+e+"-"+a,b.cs&&(d+=",cs"));return[["// JCSDL_START",this.encodeJCSDLFilter(f),d,b.id].join(" "),f,"// JCSDL_END"].join("\n")},encodeJCSDL:function(b,a){return Crypto.MD5(a+"\n"+b)},verifyJCSDL:function(b,a){var c=a.join("\n"),d=b.split(" "),
f=d[2],c=this.encodeJCSDL(c,d[3]);return f==c},encodeJCSDLFilter:function(b){return Crypto.MD5(b)},verifyJCSDLFilter:function(b,a){return b==this.encodeJCSDLFilter(a)},fieldToCSDL:function(b){return b.join(".")},valueToCSDL:function(b,a,c){var d="";if("int"==a.type||"float"==a.type){if("in"!==c&&isNaN(b))return this.error("This field value is suppose to be a Number, String given.",b,a),!1;"in"==c?(b=b.split(","),e.each(b,function(a,c){b[a]=parseInt(c)}),d="["+b.join(",")+"]"):d=b}else a=0<=e.inArray(c,
["regex_partial","regex_exact"])?!0:!1,d='"'+b.escapeCsdl(a)+'"';return d},valueFromCSDL:function(b,a,c){if("int"==b.type)return"in"==c&&(a=a.substr(1,a.length-2)),a;b=0<=e.inArray(c,["regex_partial","regex_exact"])?!0:!1;return a.unescapeCsdl(b)},tokenizeLogicString:function(b){b=(""+b).replace(/\s+/g,"");for(var a=[],c=!1,d=0;d<b.length;d++){var f=b.charAt(d);f.isNumeric()?(c?(a[a.length-1]+=""+f,a[a.length-1]=parseInt(a[a.length-1])):a.push(parseInt(f)),c=!0):(a.push(f),c=!1)}return a},validateLogic:function(b,
a){var c="string"===typeof b||"number"===typeof b?this.tokenizeLogicString(b):b;if(0<=e.inArray(c[0],["&","|"]))throw new JCSDL.LogicValidationException('Logical query cannot start with logical operator "'+c[0]+'"!',0);if(0<=e.inArray(c[c.length-1],["&","|","!"]))throw new JCSDL.LogicValidationException('Logical query cannot end with logical operator "'+c[c.length-1]+'"!',c.length-1);var d=null,f=[],h=0,l=[];a&&a.length&&e.each(a,function(a,b){l.push(parseInt(b.id))});e.each(c,function(a,b){if("("==
...
a);if(-1==e.inArray(b,l))throw new JCSDL.LogicValidationException('The filter ID "'+b+"\" doesn't exist! You can only use filters from the list of filters.",a);if(0<=e.inArray(b,f))throw new JCSDL.LogicValidationException('The filter with ID "'+b+'" has already been used in the logical expression! You can only use one filter once.',a);f.push(b)}if(0<=e.inArray(b,["(",")"])&&(h="("==b?h+1:h-1,0>h))throw new JCSDL.LogicValidationException("Parentheses do not create a logical expression, i.e. there are too many closing parenthesis that close a nested expression that was never opened!",
a);d=b});var g=[];e.each(l,function(a,b){-1==e.inArray(b,f)&&g.push(b)});if(g.length)throw new JCSDL.LogicValidationException("You haven't used some of the filters in your logical expression (with ID's: \""+g.join('", "')+'"). All filters need to be used!');if(0!==h)throw new JCSDL.LogicValidationException("You have't closed some parentheses!");return!0},error:function(b,a){this.gui.showError.apply(this.gui,arguments)},createFilter:function(b,a,c,d,f,e){f=f||{};return{id:e,target:b,fieldPath:a,operator:c,
value:d,cs:f.cs}},getOperatorCode:function(b){return this.gui.definition.operators[b].code},getTargetInfo:function(b){if(this.gui.definition.targets[b]!==j)return this.gui.definition.targets[b];this.error("Such target does not exist!",b);return!1},getFieldInfo:function(b,a){var c=this,d=this.gui.definition.targets[b];if(d===j)return this.error("Such target does not exist!",b),!1;e.each(a,function(f,e){if(d.fields!==j)if(d.fields[e]!==j)d=d.fields[e];else return c.error("Invalid path to a field (#1)!",
b,a,d),d=!1;else return c.error("Invalid path to a field (#2)!",b,a,d),d=!1});return d},transformers:[{from:"1.0",to:"2.0",filter:function(b){b=b.split(",");"augmentation.language-tag"===b[0]&&(b[0]="augmentation.language.tag");return b.join(",")}}],applyFilterJCSDLTransformers:function(b,a){var c=!1,d=b;e.each(this.transformers,function(f,e){if(c||e.from===a)c=!0,"function"===typeof e.filter&&(d=e.filter(b))});return d}};this.ValidationException=function(b,a){this.message=b;this.code=a};this.LogicValidationException=
...
c){b.find(".jcsdl-input-select-option.option-"+c).addClass("selected")})},getValue:function(b){var a=[];b.find(".jcsdl-input-select-option.selected").each(function(b,d){a.push(e(d).data("value"))});return a.join(",")},displayValue:function(b,a){var c=this,d=a.split(","),f=this.getTemplate("valueInput_select");if(0==d.length)return f;var h=this.exec("select","getOptionsSet",[b]),l=d.slice(0,5);e.each(l,function(a,b){if(h[b]===j)return!0;c.exec("select","createOptionView",[b,h[b]]).addClass("selected").appendTo(f)});
if(d.length>l.length){var g=this.getTemplate("valueInput_select_more");g.find(".count").html(d.length-l.length);g.appendTo(f)}f.find(".jcsdl-input-select-option").bind("click touchstart",function(a){a.preventDefault();a.target.blur()});return f},getOptionsSet:function(b){var a={};b.options!==j?a=b.options:b.optionsSet!==j&&this.definition.inputs.select.sets[b.optionsSet]!==j&&(a=this.definition.inputs.select.sets[b.optionsSet]);return a},createOptionView:function(b,a){var c=this.getTemplate("valueInput_select_option").data("value",
...
loadGoogleMapsApi(this.gui,this.exec,["geo_box","load",[b,a]]);return a},load:function(b,a){var c=this,d=new google.maps.Map(a.find(".jcsdl-map-canvas")[0],jcsdlMapsOptions);a.data("map",d);var f=new google.maps.Rectangle(e.extend({},this.gui.config.mapsOverlay,{}));a.data("rect",f);var h=[],l={position:new google.maps.LatLng(0,0),draggable:!0,icon:this.gui.config.mapsMarker},g=[new google.maps.Marker(l),new google.maps.Marker(l)];a.data("markers",g);this._geo.initSearch(a);google.maps.event.addListener(d,
...
0),draggable:!0,icon:this.gui.config.mapsMarker},l=new google.maps.Marker(f);a.data("centerMarker",l);var g=new google.maps.Marker(f);a.data("radiusMarker",g);a.data("center",!1);this._geo.initSearch(a);google.maps.event.addListener(d,"click",function(b){if(a.data("center")){var e=google.maps.geometry.spherical.computeDistanceBetween(h.getCenter(),b.latLng);h.setRadius(e);h.setMap(d);g.setPosition(b.latLng);g.setMap(d);c.exec("geo_radius","updateInfo",[a,h]);a.find(".jcsdl-map-instructions").html(c.definition.inputs.geo_radius.instructions[2])}else h.setCenter(b.latLng),
l.setPosition(b.latLng),l.setMap(d),a.data("center",!0),a.find(".jcsdl-map-instructions").html(c.definition.inputs.geo_radius.instructions[1]);a.find(".jcsdl-clear-map").fadeIn()});google.maps.event.addListener(l,"position_changed",function(){var a=this.getPosition(),b=h.getCenter();h.setCenter(a);if(b!==j){var c=a.lat()-b.lat(),a=a.lng()-b.lng(),b=g.getPosition(),c=new google.maps.LatLng(b.lat()+c,b.lng()+a);g.setPosition(c)}});google.maps.event.addListener(g,"position_changed",function(){h.getCenter()!==
j&&(h.setRadius(google.maps.geometry.spherical.computeDistanceBetween(h.getCenter(),this.getPosition())),c.exec("geo_radius","updateInfo",[a,h]))});a.find(".jcsdl-clear-map").bind("click touchstart",function(b){b.preventDefault();b.target.blur();h.setCenter(null);h.setMap(null);l.setMap(null);g.setMap(null);a.data("center",!1);a.find(".jcsdl-map-area span").html("0 km<sup>2</sup>");a.find(".jcsdl-map-instructions").html(c.definition.inputs.geo_radius.instructions[0]);e(this).hide()})},setValue:function(b,
a,c){var d=this,e=b.find(".jcsdl-input-geo");c=c.split(":");var h=c[0].split(","),l=1E3*parseFloat(c[1]);setTimeout(function(){var a=e.data("map"),c=e.data("circle"),k=new google.maps.LatLng(h[0],h[1]),j=e.data("centerMarker");j.setPosition(k);j.setMap(a);var j=e.data("radiusMarker"),n=google.maps.geometry.spherical.computeOffset(k,l,90);j.setPosition(n);j.setMap(a);c.setCenter(k);c.setRadius(l);c.setMap(a);e.data("center",!0);a.fitBounds(c.getBounds());d.exec("geo_radius","updateInfo",[e,c]);b.find(".jcsdl-map-instructions").html(d.definition.inputs.geo_radius.instructions[2]);
...
loadGoogleMapsApi(this.gui,this.exec,["geo_polygon","load",[b,a]]);return a},load:function(b,a){var c=this,d=new google.maps.Map(a.find(".jcsdl-map-canvas")[0],jcsdlMapsOptions);a.data("map",d);var f=e.extend({},this.gui.config.mapsOverlay,{paths:[[]],editable:!0}),h=new google.maps.Polygon(f),l=h.getPath();a.data("polygon",h);var g=new google.maps.MVCArray;a.data("markers",g);var m=1;this._geo.initSearch(a);google.maps.event.addListener(d,"click",function(a){l.push(a.latLng)});google.maps.event.addListener(l,
"insert_at",function(b){var e=new google.maps.Marker({map:d,position:l.getAt(b),draggable:!0,icon:c.gui.config.mapsMarker,zIndex:m++});g.insertAt(b,e);3<=l.getLength()&&h.setMap(d);b=3>=l.getLength()?l.getLength():3;a.find(".jcsdl-map-instructions").html(c.definition.inputs.geo_polygon.instructions[b]);c.exec("geo_polygon","updateInfo",[a,h]);a.find(".jcsdl-clear-map").fadeIn();google.maps.event.addListener(e,"position_changed",function(){var b=c.exec("geo_polygon","getMarkerIndex",[e,g]);-1!=b&&
(l.setAt(b,this.getPosition()),c.exec("geo_polygon","updateInfo",[a,h]))});google.maps.event.addListener(e,"dblclick",function(){var b=c.exec("geo_polygon","getMarkerIndex",[e,g]);-1!=b&&(l.removeAt(b),g.removeAt(b),this.setMap(null),c.exec("geo_polygon","updateInfo",[a,h]))})});google.maps.event.addListener(l,"set_at",function(a){var b=g.getAt(a);a=l.getAt(a);b.getPosition().equals(a)||b.setPosition(a)});a.find(".jcsdl-clear-map").bind("click touchstart",function(b){b.preventDefault();b.target.blur();
g.forEach(function(a){a.setMap(null)});g.clear();l.clear();c.exec("geo_polygon","updateInfo",[a,h]);a.find(".jcsdl-map-instructions").html(c.definition.inputs.geo_polygon.instructions[0]);e(this).hide()})},setValue:function(b,a,c){var d=this,f=b.find(".jcsdl-input-geo");c=c.split(":");setTimeout(function(){var a=f.data("polygon"),l=f.data("map");e.each(c,function(b,c){c=c.split(",");var d=new google.maps.LatLng(parseFloat(c[0]),parseFloat(c[1]));a.getPath().push(d)});l.fitBounds(a.getBounds());d.exec("geo_polygon",
...
for(var f=1;f<=b.fields;f++){var h=this.$el.clone().removeClass("orig").show().attr("placeholder","Test your expression against this field..."),l=e('<div class="jcsdl-regex-tester-input-wrap" />').html(h).append('<div class="jcsdl-regex-result jcsdl-elements-sprite" />');l.prependTo(this.$wrap);this.$fields=this.$fields.add(h);this.$fieldsWraps=this.$fieldsWraps.add(l)}this.$btn.bind("click touchstart",function(a){a.preventDefault();a.target.blur();d.$fieldsWraps.fadeIn();e(this).addClass("active")});
this.$el.bind("keyup change",function(){d.val=d.$el.val();d.test()});this.$fields.bind("keyup",function(){d.test(e(this))});this.disable()};b.prototype={mode:"partial",val:"",test:function(a){var b=this;a=a!==j?a:this.$fields;var d=this.val.replace(/\//g,"/");this.exp=RegExp("partial"==this.mode?""+d+"":"^"+d+"$","i");a.each(function(a,d){if(0==e(d).val().length||0==b.val.length)return e(d).siblings(".jcsdl-regex-result").hide(),!0;var l=b.exp.test(e(d).val())?"ok":"err";e(d).siblings(".jcsdl-regex-result").removeClass("ok err").addClass(l).fadeIn()})},
...
e.jcsdlPopup=function(a){return new b(a)}});JCSDL.Loader.addComponent(function(e,j){e.fn.animateIntoView=function(b,a,c){b=b===j?200:b;a=parseInt(a)||0;c="function"==typeof c?c:function(){};var d=e(this[0]);if(!d.length)return this;var f=e("body"),h=e("html"),d=d.offset().top,l=parseInt(f.scrollTop()),g=l+e(window).height();if(l<d&&d<g)return this;f.add(h).animate({scrollTop:d-a},b,c);return this}});
...
c));if((e[1]||"").length<b)e[1]=e[1]||"",e[1]+=Array(b-e[1].length+1).join("0");return e.join(a)}})});JCSDL.Loader.addComponent(function(e,j){this.GUIFilterEditor=function(b,a,c){a=a||e();c=c||{};var d=this;this.gui=b;this.config=b.config;this.definition=b.definition;this.parser=b.parser;this.inputs=b.inputs;this.getTemplate=b.getTemplate;this.getIconForField=b.getIconForField;this.filter=c;this.steps=[];this.target=null;this.path=[];this.$view=this.getTemplate("filterEditor");this.$steps=this.$view.find(".jcsdl-steps");this.$search=this.$view.find(".jcsdl-search");this.$searchInput=this.$view.find(".jcsdl-search input");
this.$searchResults=this.$view.find(".jcsdl-search-results");this.$view.appendTo(a).show();this.addFilterStep("target",this.createTargetSelectView());this.$view.find(".jcsdl-filter-save").hide();this.$view.find(".jcsdl-footer span").hide();this.populateSearch();this.$view.find(".jcsdl-filter-save").bind("click touchstart",function(a){a.preventDefault();a.target.blur();d.didSubmitFilter()});this.$view.find(".jcsdl-filter-cancel").bind("click touchstart",function(a){a.preventDefault();a.target.blur();
d.gui.hideFilterEditor();d.trigger("filterCancel")});this.$searchInput.focus(function(){d.$search.addClass("jcsdl-active");d.$searchResults.show()});this.$searchInput.blur(function(){d.$searchResults.fadeOut(200);d.$search.removeClass("jcsdl-active")});this.$searchInput.keypress(function(a){if(13===a.which)return a=d.$searchResults.find("li.jcsdl-selected"),a.length&&d.selectTarget(a.data("target")),!1});this.$searchInput.bind("keyup",function(a){if(27===a.which)d.$searchInput.val("").blur(),d.$searchResults.children().show();
else if(38===a.which||40===a.which)a.preventDefault();else{a=e.trim(d.$searchInput.val());var b=RegExp("(^|\\s)("+a+"|"+a.replace(/\s/g,".")+")","i"),c=RegExp("(^|\\s)("+a.replace(/\s/g,"|")+")","gi");d.$searchResults.children().quickEach(function(){b.test(this.data("name"))||b.test(this.data("target"))?this.show().find("span").html(this.data("fullname").replace(c,"$1<strong>$2</strong>")):this.hide()})}});this.$searchInput.bind("keydown",function(a){if(-1!==e.inArray(a.which,[38,40])){a.preventDefault();
var b=d.$searchResults.find("li.jcsdl-selected").removeClass("jcsdl-selected"),c=b.length&&b.nextAll("li:visible:first").length?b.nextAll("li:visible:first"):d.$searchResults.find("li:visible:first"),g=b.length&&b.prevAll("li:visible:first").length?b.prevAll("li:visible:first"):d.$searchResults.find("li:visible:last");38===a.which?b=g.addClass("jcsdl-selected"):40===a.which&&(b=c.addClass("jcsdl-selected"));b.scrollIntoView(d.$searchResults)}});this.$view.find(".jcsdl-search-arrow").click(function(){d.$searchInput.focus();
return!1});this.loadFilter(c)};this.GUIFilterEditor.prototype={filter:{},jsonpCache:{operators:{},targets:{}},adjust:function(){this.$steps.find(".jcsdl-step").jcsdlCarousel("adjust")},loadFilter:function(b){this.filter=b;if(b===j||!b||b.target===j)return!1;this.selectTarget(b.target+"."+b.fieldPath.join("."));var a=this.parser.getFieldInfo(b.target,b.fieldPath);"string"!==typeof a.input&&this.$view.find(".jcsdl-filter-target-field-input .input-"+b.operator).trigger("jcsdlclick");"text"===a.input?
e(".jcsdl-dropdown .jcsdl-dropdown-option.operator-"+b.operator).click():this.$view.find(".jcsdl-filter-value-input-operators .operator-"+b.operator).click();var c=this.$view.find(".jcsdl-filter-value-input-field");this.setValueForField(c,a,b.value,b.operator);b.cs&&this.$view.find(".jcsdl-operator-cs").click()},selectTarget:function(b){var a=this;b=b.split(".");var c=b.shift();this.$view.find(".jcsdl-filter-target .target-"+c).trigger("jcsdlclick");e.each(b,function(b,c){a.$view.find(".jcsdl-filter-target-field:last").find(".field-"+
c).trigger("jcsdlclick")})},addFilterStep:function(b,a,c){c=c===j?!0:c;var d=this,f=this.getTemplate("step"),h=this.steps.length;f.html(a).data("number",h).addClass("jcsdl-filter-step-number-"+h).data("name",b).addClass("jcsdl-filter-step-"+b).appendTo(this.$steps);"target"===b&&f.jcsdlCarousel({select:function(){var a=e(this);f.addClass("selected").find(".jcsdl-carousel-item.selected").removeClass("selected");a.addClass("selected");d.didSelectTarget(a.data("name"))}});"field"===b&&f.jcsdlCarousel({select:function(){var b=
e(this);d.$steps.find(".jcsdl-filter-step-target").addClass("field-selected");var c=f.data("number")-1;d.$steps.find(".jcsdl-filter-step-field.jcsdl-filter-step-number-"+c).addClass("field-selected");f.addClass("selected").find(".jcsdl-carousel-item.selected").removeClass("selected");b.addClass("selected");d.didSelectField(b.data("name"),a,f)}});"input"===b&&f.jcsdlCarousel({select:function(){var b=e(this),c=f.data("number")-1;d.$steps.find(".jcsdl-filter-step-field.jcsdl-filter-step-number-"+c).addClass("field-selected");
f.addClass("selected").find(".jcsdl-carousel-item.selected").removeClass("selected");b.addClass("selected");d.didSelectInput(b.data("name"),a,f)}});"value"===b&&(this.$view.find(".jcsdl-filter-save").fadeIn(this.config.animate),this.$view.find(".jcsdl-footer span").show());c?f.hide().slideDown(this.config.animate):"field"===b?f.find(".jcsdl-filter-target-field").hide().fadeIn(this.config.animate):f.hide().fadeIn(this.config.animate);setTimeout(function(){d.adjust()},this.config.animate);this.steps.push(f)},
removeFilterStepsAfterPosition:function(b){this.$steps.find(".jcsdl-step").eq(b).removeClass("field-selected");b=this.steps.splice(b+1,this.steps.length-b);var a="";this.$view.find(".jcsdl-filter-save").hide();this.$view.find(".jcsdl-footer span").hide();e.each(b,function(b,d){var f=e(d);b||(a=f.data("name"));f.remove()});return a},didSelectTarget:function(b){if(this.definition.targets[b]===j)return!1;this.target=b;this.path=[];var a=this.removeFilterStepsAfterPosition(0),c=this.createFieldSelectionView(this.definition.targets[b].fields);
this.addFilterStep("field",c,"field"!==a);this.trigger("targetSelect",[b])},didSelectField:function(b,a,c){var d=a.data("position");this.path.splice(d,this.path.length-d);c.removeClass("selected-final").find(".jcsdl-target-help").remove();d=this.getFieldInfoAtCurrentPath(b);if(!1!==d){var e=this.removeFilterStepsAfterPosition(a.closest(".jcsdl-step").data("number"));this.path.push(b);d.fields!==j?(a=this.createFieldSelectionView(d.fields),this.addFilterStep("field",a,"field"!==e)):"string"!==typeof d.input?
(c="input"!==e,b=this.createInputSelectionView(d.input),this.addFilterStep("input",b,c)):(b=this.createValueInputView(d),this.addFilterStep("value",b,"value"!==e),this.addTargetHelpToStep(c),this.trigger("targetSelect",[this.getCurrentPath()]))}},didSelectInput:function(b,a,c){a=this.removeFilterStepsAfterPosition(a.closest(".jcsdl-step").data("number"));c.removeClass("selected-final").find(".jcsdl-target-help").remove();b=this.createValueInputView(this.getFieldInfoAtCurrentPath(),b);this.addFilterStep("value",
b,"value"!==a);this.addTargetHelpToStep(c)},addTargetHelpToStep:function(b){var a=this;this.getTemplate("targetHelp").appendTo(b);b.find(".jcsdl-target-help").click(function(b){b.preventDefault();b.target.blur();b=a.getFieldInfoAtCurrentPath();var d=a.target,f=a.parser.getTargetInfo(d),h=a.path.join("-"),l=f.name,g=[];e.each(a.path,function(b,c){g.push(c);l+=" &raquo; "+a.parser.getFieldInfo(d,g).name});var m=h;"augmentation"!==d&&(m=d+"."+m);b=a.config.targetHelpUrl.apply(a,[m.replace(/-/g,"."),
b]);var k=e.jcsdlPopup({title:l});a.jsonpCache.targets[m]===j?e.ajax({url:b,type:"GET",async:!1,jsonpCallback:"jcsdlJSONP",contentType:"application/json",dataType:"jsonp",success:function(b){!b||!b.html||!e.trim(b.html)?(k.setContent("<p>No documentation available.</p>"),k.reposition()):(k.setContent(b.html),k.reposition(),a.jsonpCache.targets[m]=b.html)},error:function(){k.setContent("<p>No documentation available.</p>");k.reposition()}}):(k.setContent(a.jsonpCache.targets[m]),k.reposition())})},
didSubmitFilter:function(){var b=this.getFilterInfo();b&&this.gui.didSubmitFilter(b)},showError:function(b,a){this.$view.find(".jcsdl-error").remove();var c=this.getTemplate("error");c.find("span").html(b);c.prependTo(this.$view.find(".jcsdl-footer")).hide().fadeIn();window.console!==j&&window.console.error(b,arguments)},trigger:function(b,a){this.gui.trigger(b,a)},createTargetSelectView:function(){var b=this,a=this.getTemplate("target"),c=a.find(".jcsdl-filter-target");e.each(this.definition.targets,
function(a,e){b.createOptionForTarget(a,e).appendTo(c)});return a},createOptionForTarget:function(b,a){var c=this.getTemplate("targetOption").data("name",b).data("target",a).addClass("target-"+b);this.isTargetVisible(b)||(c.addClass("jcsdl-option-hidden"),(this.filter.target===j||this.filter.target!==b)&&c.hide());return c},createFieldSelectionView:function(b){var a=this,c=this.path.length,d=this.target+(0<this.path.length?"."+this.path.join("."):""),f=this.getTemplate("field"),h=!1,l=e.merge([this.target],
this.path),g="";f.data("position",c).addClass("field-select-"+c);e.each(l,function(b,c){g=g+(0<b?".":"")+c;if(!a.isTargetVisible(g))return h=!0});var j=f.find(".jcsdl-filter-target-field");e.each(b,function(b,c){a.createOptionForField(b,c,d,h).appendTo(j)});return f},createOptionForField:function(b,a,c,d){var f=this;a=this.getTemplate("fieldOption").data("name",b).data("field",a).html(a.name).addClass("icon-"+this.getIconForField(b,a)).addClass("field-"+b);if(!d){var h=c+"."+b;if(this.isTargetVisible(h)){var h=
h.split("-"),l="";e.each(h,function(a,b){l+=(0<a?".":"")+b;if(!f.isTargetVisible(l))return d=!0})}else d=!0}d&&a.addClass("jcsdl-option-hidden");d&&this.filter&&this.filter.target!==j&&this.filter.fieldPath!==j&&this.filter.target+"."+this.filter.fieldPath.join(".").replace(/-/g,".")===c+"."+b&&(d=!1);d&&a.hide();return a},createInputSelectionView:function(b){var a=this,c=this.getTemplate("inputSelect"),d=c.find(".jcsdl-filter-target-field-input");e.each(b,function(b,c){a.createOptionForInput(c).appendTo(d)});
return c},createOptionForInput:function(b){return this.getTemplate("inputSelectOption").data("name",b).addClass("icon-"+b+" input-"+b).html(b)},createValueInputView:function(b,a){a=a||b.input;var c=this.getTemplate("valueInput");if(this.inputs[a]===j)return c;var d=this.inputs.exec(a,"init",[b]),d=c.find(".jcsdl-filter-value-input-field").data("inputType",a).html(d),e=c.find(".jcsdl-filter-value-input-operators");"text"===a?this.createTextOperatorsSelectView(e,b,a,d):this.createOperatorsSelectView(e,
b,a,d);return c},createOperatorsSelectView:function(b,a,c,d){var f=this,h=d.find("input:first"),l=this.definition.inputs[c]!==j?this.definition.inputs[c]:{},g=l.operators!==j?l.operators:[];e.each(a.operators,function(a,c){if(0<g.length&&-1===e.inArray(c,g))return!0;var d=f.createOperatorOptionView(c);e("html").is(".msie")&&d.html("&nbsp;");b.append(d)});b.children().bind("click touchstart",function(a){a.preventDefault();a.target.blur();var g=e(this);a=g.data("name");b.children().removeClass("selected");
g.addClass("selected");"exists"===a?d.fadeOut(f.config.animate):d.is(":visible")||d.fadeIn(f.config.animate);"number"===c&&(g=0<=e.inArray(a,l.arrayOperators)?"enable":"disable",h.jcsdlTagInput(g));f.trigger("operatorSelect",[a])});1===b.children().length?(b.children().eq(0).click(),b.children().hide()):(a=b.find(".operator-"+(a.operator!==j?a.operator:l.operator)),0<a.length?a.click():b.find(".operator:not(.operator-exists):first").click());return b},createTextOperatorsSelectView:function(b,a,c,
d){var f=this;e(".jcsdl-dropdown").remove();b.addClass("text");var h=d.find("input.orig"),l=this.getTemplate("textOperatorsSelect"),g=this.getTemplate("textOperatorsDropdown"),m=this.definition.inputs[c]!==j?this.definition.inputs[c]:{},k=m.operators!==j?m.operators:[];e.each(a.operators,function(a,b){if(0<k.length&&-1===e.inArray(b,k))return!0;var c=f.createTextOperatorOptionView(b);g.append(c)});b.html(l).insertAfter(d);g.hide().appendTo("body");if(a.cs){var q=this.getTemplate("caseSensitivity");
q.bind("click touchstart",function(a){a.preventDefault();a.target.blur();e(this).toggleClass("selected");f.trigger("caseSensitivityChange",[e(this).is(".selected")])}).tipsy({gravity:"s",offset:9});q.prependTo(b);l.addClass("has-cs")}l.click(function(a){a.preventDefault();a.target.blur();a.stopPropagation();l.hasClass("active")?(g.slideUp(f.config.animate),l.removeClass("active")):(g.css({top:l.offset().top+l.outerHeight()-1,left:l.offset().left,width:l.outerWidth()-2}).slideDown(f.config.animate),
l.addClass("active"),e("body").bind("click.jcsdldropdown",function(a){a=e(a.target).closest(".jcsdl-dropdown");if(null===a||!a.is(".jcsdl-dropdown"))l.removeClass("active"),g.slideUp(f.config.animate),e("body").unbind("click.jcsdldropdown")}))});g.find(".jcsdl-dropdown-details-trigger, .jcsdl-operator-help").click(function(a){a.preventDefault();a.target.blur();a.stopPropagation();a=e(this).closest(".jcsdl-dropdown-option");var b=a.data("name"),c=e.jcsdlPopup({title:a.data("title")});f.jsonpCache.operators[b]===
j?e.ajax({url:a.data("jsonp"),type:"GET",async:!1,jsonpCallback:"jcsdlJSONP",contentType:"application/json",dataType:"jsonp",success:function(a){!a||!a.html||!e.trim(a.html)?(c.setContent("<p>No documentation available.</p>"),c.reposition()):(c.setContent(a.html),c.reposition(),f.jsonpCache.operators[b]=a.html)}}):(c.setContent(f.jsonpCache.operators[b]),c.reposition())});g.find(".jcsdl-dropdown-option").click(function(b){b.preventDefault();b.target.blur();l.removeClass("active");g.hide();b=e(this).data("name");
var c=f.definition.operators[b];l.data("operator",b).find(".jcsdl-operator-label").html(c.label);"exists"===b?(d.fadeOut(f.config.animate),a.cs&&q.fadeOut(f.config.animate)):d.is(":visible")||(d.fadeIn(f.config.animate),a.cs&&q.fadeIn(f.config.animate));"contains_near"===b?(d.find(".jcsdl-containsnear-distance").fadeIn(),d.find(".jcsdl-tag-field input").bind("keydown.nospace",function(a){32===a.which&&a.preventDefault()}),h.jcsdlTagInput("update",!0),h.data("split",!0)):(d.find(".jcsdl-containsnear-distance").hide(),
d.find(".jcsdl-tag-field input").unbind("keydown.nospace"),h.data("split")&&(h.jcsdlTagInput("update"),h.data("split",!1)));c=0<=e.inArray(b,m.arrayOperators)?"enable":"disable";h.jcsdlTagInput(c);"enable"===c&&h.jcsdlTagInput("update");c=0<=e.inArray(b,["regex_partial","regex_exact"])?"enable":"disable";h.jcsdlRegExTester(c);"enable"===c&&(h.jcsdlRegExTester("set"+("regex_partial"===b?"Partial":"Exact")),h.jcsdlRegExTester("test"));f.trigger("operatorSelect",[b])});e(window).resize(function(){l.hasClass("active")&&
g.css({top:l.offset().top+l.outerHeight()-1,left:l.offset().left,width:l.outerWidth()-2})});1===g.find(".jcsdl-dropdown-option").length?g.find(".jcsdl-dropdown-option:first").click():(c=g.find(".jcsdl-dropdown-option.operator-"+(a.operator!==j?a.operator:m.operator)),0<c.length?c.click():g.find(".jcsdl-dropdown-option:not(.operator-exists):first").click());return b},createOperatorOptionView:function(b){var a=this.definition.operators[b];return a===j?e():this.getTemplate("operatorOption").data("name",
b).addClass("icon-"+b+" operator-"+b).attr("title",a.description).html(a.label).tipsy({gravity:"s",offset:9})},createTextOperatorOptionView:function(b){var a=this.definition.operators[b];if(a===j)return e();var c=this.getTemplate("textOperatorOption").data("name",b).data("title",a.label).addClass("operator-"+b);c.find(".jcsdl-icon").addClass("icon-"+b+" operator-"+b+" selected");c.find(".jcsdl-operator-label span").html(a.label);c.find(".jcsdl-operator-desc").html(a.description);a.jsonp?c.data("jsonp",
a.jsonp):(c.find(".jcsdl-dropdown-details-trigger").remove(),c.find(".jcsdl-operator-help").remove());return c},setValueForField:function(b,a,c,d){var f=this,h=b.data("inputType");if(this.inputs[h]===j)return!1;if(0<=e.inArray(h,["geo_box","geo_radius","geo_polygon"])){var l=jcsdlMapsCurrentGui,g=jcsdlMapsCurrentCallback,m=jcsdlMapsCurrentCallbackArgs;jcsdlMapsCurrentCallback=function(){l&&g&&setTimeout(function(){g.apply(l.inputs,m);f.inputs.exec(h,"setValue",[b,a,c,d])},l.config.animate+10)}}else this.inputs.exec(h,
"setValue",[b,a,c,d]);return!0},getValueFromField:function(b,a,c){var d=b.data("inputType");return this.inputs[d]===j?"":this.inputs.exec(d,"getValue",[b,a,c])},populateSearch:function(){var b=this,a=function(c,d,f,h){f=f.length?f+"."+c:c;h=h.length?h+"|"+d.name:d.name;b.isTargetVisible(f)&&(d.fields!==j?e.each(d.fields,function(b,c){a(b,c,f,h)}):(c=b.getTemplate("filterEditor_searchItem"),c.data("name",h.replace(/\|/g," ")).data("fullname",h.replace(/\|/g," &raquo; ")).data("target",f).find("span").html(c.data("fullname")),
c.find(".jcsdl-icon").addClass("target-"+f.split(".")[0]),c.click(function(){b.selectTarget(f);return!1}),c.appendTo(b.$searchResults)))};e.each(this.definition.targets,function(b,d){a(b,d,"","")})},getView:function(){return this.$view},getFilterInfo:function(){var b=this.getFieldInfoAtCurrentPath(),a="text"===b.input?this.$view.find(".jcsdl-filter-value-input-operators .jcsdl-operators-select").data("operator"):this.$view.find(".jcsdl-filter-value-input-operators .operator.selected").data("name");
if(a===j)this.showError("You need to select an operator!");else{var c="";if("exists"!==a&&(c=this.$view.find(".jcsdl-filter-value-input-field"),c=this.getValueFromField(c,b,a),!c.length)){this.showError("You need to specify a value!");return}return{target:this.target,path:this.path,operator:a,value:c,additional:{cs:"exists"!==a&&b.cs&&0<this.$view.find(".jcsdl-operator-cs.selected").length?!0:!1}}}},getFieldInfoAtCurrentPath:function(b){var a=this.path.slice(0);"string"===typeof b&&a.push(b);return this.parser.getFieldInfo(this.target,
a)},getCurrentPath:function(){return this.target+(0<this.path.length?".":"")+this.path.join(".").replace(/-/g,".")},isTargetVisible:function(b){if(!b)return!1;var a=this.config.showTargets;if(a.length){if(0<=e.inArray(b,a))return!0;for(var c=b.split(".");c.length;){if(0<=e.inArray(c.join("."),a))return!0;c.pop()}b+=".";for(c=0;c<a.length;c++)if(0===a[c].indexOf(b))return!0;return!1}return-1===e.inArray(b,this.config.hideTargets)}}});JCSDL.Loader.addComponent(function(e,j){this.GUILogic=function(b,a){var c=this;this.gui=b;this.config=b.config;this.parser=b.parser;this.getTemplate=b.getTemplate;this.$logicOptions=b.$mainView.find(".jcsdl-filters-logic .jcsdl-filters-logic-option:not(.jcsdl-advanced-option)");this.$advancedOptions=b.$mainView.find(".jcsdl-filters-logic .jcsdl-filters-logic-option.jcsdl-advanced-option");this.$insertBracketsButton=this.$advancedOptions.filter(".jcsdl-advanced-add-brackets");this.$insertNotOperatorButton=
...
addGuiToken:function(b,a,c){a=a===j?!0:a;c=c===j?!1:c;var d=this,f="number"==typeof b?"filter":b;if(this.tokensMap[f]===j)throw'Invalid character "'+b+'" in the logic!';var h=this.getTemplate("logicToken_"+this.tokensMap[f]).data("token",b),l=e();"filter"==f&&h.html(b);f=e('<li class="jcsdl-logic-token-wrap" />').html(h)["!"===b&&c?"prependTo":"appendTo"](this.$gui);this.$gui.width(this.$gui.width()+f.outerWidth(!0));if(")"==b&&c){l=this.getTemplate("logicToken_bracketOpen").data("token","(");b=this.getGuiTokens().reverse();
var g=b.length,m=-1,k=null;e.each(b,function(a,b){")"==b?m++:"("==b&&m--;if(0==m&&0<=e.inArray(b,["&","|"])){if(null!==k&&b!==k)return g=a,!1;k=b}});b=this.$gui.children().eq(b.length-g);b=e('<li class="jcsdl-logic-token-wrap" />').html(l).insertBefore(b);this.$gui.width(this.$gui.width()+b.outerWidth(!0))}this.updateFromGui();this.adjustGui();a&&this.scrollGuiToToken(h);h.click(function(a){a.preventDefault();a.target.blur();"&"==h.data("token")?(h.data("token","|").html("OR"),d.trigger("logicOperatorSwitch",
["OR"]),a=d.getGuiString(),d.trigger("graphicalLogicChange",[a]),d.trigger("advancedLogicChange",[a])):"|"==h.data("token")&&(h.data("token","&").html("AND"),d.trigger("logicOperatorSwitch",["AND"]),a=d.getGuiString(),d.trigger("graphicalLogicChange",[a]),d.trigger("advancedLogicChange",[a]));d.updateFromGui()});h.add(l).find(".jcsdl-delete-token").click(function(a){a.preventDefault();a.target.blur();a.stopPropagation(!0);d.deleteGuiToken(h);a=d.getGuiString();var b="!"===h.data("token")?"notOperatorDelete":
...
h=[];e.each(c,function(a,b){"//"!==b.substr(0,2)&&h.push(b)});var j=h.join("\n"),g="jcsdl-copy-to-clipboard-"+Math.floor(1E4*Math.random());e.jcsdlPopup({title:"CSDL Preview",content:["<p>"+b.highlightCSDL(j)+"</p>",'<a href="#" id="'+g+'" class="jcsdl-btn jcsdl-copy-to-clipboard"><i class="jcsdl-picto jcsdl-elements-sprite"></i></a>'].join("")});var m=e("#"+g).zclip({path:b.config.zeroClipboard,copy:j,afterCopy:function(){clearTimeout(void 0);m.addClass("copied");setTimeout(function(){m.removeClass("copied")},
